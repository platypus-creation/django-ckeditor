...
(function() {
        ...
        return {
            ...
            on: function(a, e, d, c, k) {
                ...
                if (o.getListenerIndex(e) < 0) {
                    ...
                    h.fn = e;
                    h.priority = k;
                    for (var l = o.length - 1; l >= 0; l--) if (o[l].priority <= k) {
                        o.splice(l + 1, 0, h);
                        return {
                            removeListener: n
                        }
                    ...
                    if (o) {
                        ...
                        if (l.length) for (var l = l.slice(0), j, q = 0; q < l.length; q++) {
                            if (o.errorProof) try {
                                j = l[q].call(this,
                                n, h, b, g)
                            } catch (C) {} else j = l[q].call(this, n, h, b, g);
        ...
        CKEDITOR.tools = {
            ...
            convertRgbToHex: function(a) {
                return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function(a, b, c, g) {
                    a = [b, c, g];
                    for (b = 0; b < 3; b++) a[b] = ("0" + parseInt(a[b], 10)
                        .toString(16))
                        .slice(-2);
                    return "#" + a.join("")
                })
            ...
            parseCssText: function(a, b, c) {
                ...
                if (!a || a == ";") return d;
                a.replace(/&quot;/g, '"')
                    .replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, c, e) {
                    if (b) {
                        c = c.toLowerCase();
                        c == "font-family" && (e = e.toLowerCase()
                            .replace(/["']/g, "")
                            .replace(/\s*,\s*/g, ","));
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getAddress: function(b) {
            for (var c = [], a = this.getDocument()
                .$.documentElement, f = this.$; f && f != a;) {
                var e = f.parentNode;
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getHead: function() {
            ...
            return b = b ? new CKEDITOR.dom.element(b) : this.getDocumentElement()
                .append(new CKEDITOR.dom.element("head"), true)
        },
        getBody: function() {
    ...
    CKEDITOR.dom.element = function(b, c) {
        typeof b == "string" && (b = (c ? c.$ : document)
            .createElement(b));
        CKEDITOR.dom.domObject.call(this, b)
    };
    ...
    CKEDITOR.dom.element.setMarker = function(b, c, a, f) {
        var e = c.getCustomData("list_marker_id") || c.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber())
            .getCustomData("list_marker_id"),
            d = c.getCustomData("list_marker_names") || c.setCustomData("list_marker_names", {})
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeClass: function(a) {
                ...
                if (b) {
                    a = RegExp("(?:^|\\s+)" + a + "(?=\\s|$)", "i");
                    if (a.test(b))(b = b.replace(a, "")
                        .replace(/^\s+/, "")) ? this.setAttribute("class",
            ...
            append: function(a, b) {
                typeof a == "string" && (a = this.getDocument()
                    .createElement(a));
            ...
            appendBogus: function() {
                ...
                if (!a || !a.is || !a.is("br")) {
                    a = CKEDITOR.env.opera ? this.getDocument()
                        .createText("") : this.getDocument()
                        .createElement("br");
                ...
                return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function(a) {
                    ...
                    case "contentEditable":
                        return this.$.attributes.getNamedItem("contentEditable")
                            .specified ? this.$.getAttribute("contentEditable") : null
                    }
                    return this.$.getAttribute(a, 2)
                } : a
            }(),
            ...
            isVisible: function() {
                ...
                if (a && (CKEDITOR.env.webkit || CKEDITOR.env.opera)) {
                    b = this.getWindow();
                    if (!b.equals(CKEDITOR.document.getWindow()) && (c = b.$.frameElement)) a = (new CKEDITOR.dom.element(c))
                        .isVisible()
                }
                return !!a
            },
            ...
            mergeSiblings: function() {
                function a(a, b, c) {
                    if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (a.isIdentical(b)) {
                            for (var k = c ? a.getLast() : a.getFirst(); g.length;) g.shift()
                                .move(a, !c);
                            b.moveChildren(a, !c);
                            b.remove();
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var h = this.$.getBoundingClientRect(),
                        n = d.$.documentElement,
                        o = n.clientTop || g.$.clientTop || 0,
                        m = n.clientLeft || g.$.clientLeft || 0,
                        l = true;
                    if (CKEDITOR.env.ie) {
                        l = d.getDocumentElement()
                            .contains(this);
                        d = d.getBody()
                            .contains(this);
                        l = k && d || !k && l
                    ...
                    if (l) {
                        b = h.left + (!k && n.scrollLeft || g.$.scrollLeft);
                        b = b - m;
                        c = h.top + (!k && n.scrollTop || g.$.scrollTop);
                        c = c - o
                    }
                } else {
                    g = this;
                ...
                if (a) {
                    ...
                    if (!g.equals(d) && g.$.frameElement) {
                        a = (new CKEDITOR.dom.element(g.$.frameElement))
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function n(b, l) {
                    if (/body|html/.test(a.getName())) a.getWindow()
                        .$.scrollBy(b, l);
                    else {
                ...
                function o(a, b) {
                    ...
                    j = a.getWindow();
                    if (!j.equals(b)) {
                        j = o(CKEDITOR.dom.element.get(j.$.frameElement), b);
                        m.x = m.x + j.x;
                        m.y = m.y + j.y
                    }
                    return m
                ...
                var C = a.$.clientHeight,
                    x = a.$.clientWidth;
                k = g.x - m(this, "left") - j.x || 0;
                h = g.y - m(this, "top") - j.y || 0;
                d = g.x + d + m(this, "right") - (j.x + x) || 0;
                g = g.y + q + m(this, "bottom") - (j.y + C) || 0;
                if (h < 0 || g > 0) n(0, b === true ? h : b === false ? g : h < 0 ? h : g);
                if (c && (k < 0 || d > 0)) n(k < 0 ? k : d, 0)
            },
            ...
            disableContextMenu: function() {
                ...
                function(a) {
                    a.data.getTarget()
                        .hasClass("cke_enable_context_menu") || a.data.preventDefault()
                })
            },
            getDirection: function(a) {
                return a ? this.getComputedStyle("direction") || this.getDirection() || this.getParent() && this.getParent()
                    .getDirection(1) || this.getDocument()
                    .$.dir || "ltr" : this.getStyle("direction") || this.getAttribute("dir")
            },
            data: function(a, b) {
                a = "data-" + a;
    ...
    (function() {
        function b(a, b) {
            ...
            if (a && !this._.guardRTL) {
                var A = o.type == CKEDITOR.NODE_ELEMENT ? o : o.getParent(),
                    B = o.type == CKEDITOR.NODE_ELEMENT ? m ? o.getChild(m - 1) : null : o.getPrevious();
            ...
            if (this.current) d = this.current[e](false, f, j);
                ...
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = l > 0 ? d.getChild(l - 1) : j(d, true) === false ? null : d.getPreviousSourceNode(true, f, j));
                else {
                    d = o;
                    if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(m))) d = j(o, true) === false ? null : o.getNextSourceNode(true, f, j)
                }
                d && j(d) === false && (d = null)
            }
            for (; d && !this._.end;) {
        ...
        CKEDITOR.dom.walker.bookmark = function(a, b) {
            ...
            return function(d) {
                var o, m;
                o = d && d.type != CKEDITOR.NODE_ELEMENT && (m = d.getParent()) && c(m);
                o = a ? o : o || c(d);
                return !!(b ^ o)
            }
        };
    ...
    (function() {
        function b() {
            ...
            return function(q) {
                ...
                return q.type == CKEDITOR.NODE_TEXT && (q.hasAscendant("pre") || CKEDITOR.tools.trim(q.getText())
                    .length) || q.type == CKEDITOR.NODE_ELEMENT && !q.is(d) ? false : true
            }
        }
        function c(a) {
            var b = CKEDITOR.dom.walker.whitespaces(),
            ...
            return function(c) {
                return l(c) || b(c) ? true : !a && g(c) || c.type == CKEDITOR.NODE_ELEMENT && c.is(CKEDITOR.dtd.$removeEmpty)
            }
        }
        function a(a) {
            return !k(a) && !h(a)
        ...
        var f = function(a) {
            ...
            else if (g.getChildCount() > 0) if (i >= g.getChildCount()) {
            ...
            if (b == 2) {
                ...
                if (p && n && (d.$.parentNode != p.$.parentNode || g.$.parentNode != n.$.parentNode)) {
                    b = n.getIndex();
                    e && n.$.parentNode == d.$.parentNode && b--;
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function(a) {
                ...
                if (a) {
                    if (b.type == CKEDITOR.NODE_ELEMENT) {
                        if ((f = b.getChild(c)) && f.type == CKEDITOR.NODE_TEXT && c > 0 && f.getPrevious()
                    ...
                    if (!g) {
                        if (l.type == CKEDITOR.NODE_ELEMENT) {
                            if ((f = l.getChild(d)) && f.type == CKEDITOR.NODE_TEXT && d > 0 && f.getPrevious()
                                .type == CKEDITOR.NODE_TEXT) {
                                l = f;
                                d = 0
                            }
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    if (p.type == CKEDITOR.NODE_TEXT) {
                        if (n) {
                            p = !CKEDITOR.tools.trim(p.substring(0, n))
                                .length && p;
                            k = !! p
                        }
                        if (p && !(e = p.getPrevious())) i = p.getParent()
                    } else {
                        n && (e = p.getChild(n - 1) || p.getLast());
                        e || (i = p)
                    }
                    for (; i || e;) {
                        if (i && !e) {
                        ...
                        for (; e;) {
                            ...
                            if (e.type == CKEDITOR.NODE_COMMENT) e = e.getPrevious();
                                ...
                                if (e.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    n = e.getText();
                                    if (/[^\s\ufeff]/.test(n)) e = null;
                                    else for (var u = e.$.getElementsByTagName("*"), r = 0, D; D = u[r++];) if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) {
                                        e = null;
                                        break
                                    }
                                    e && (p = !! n.length)
                    ...
                    h = k = false;
                    if (p.type == CKEDITOR.NODE_TEXT) {
                        p = !CKEDITOR.tools.trim(p.substring(n))
                            .length && p;
                        k = !(p && p.getLength());
                        if (p && !(e = p.getNext())) i = p.getParent()
                    } else(e = p.getChild(n)) || (i = p);
                    for (; i || e;) {
                        if (i && !e) {
                            !h && i.equals(j) && (h = true);
                            if (c ? i.isBlockBoundary() : !d.contains(i)) break;
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    i = i.lastForward();
                    v = v || d;
                    this.setEndAt(v, !i && this.checkEndOfBlock() || i && v.contains(i) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT,
                        ...
                        k = 1,
                        h = 1;
                    if (d && d.type == CKEDITOR.NODE_TEXT) if (f) if (f >= d.getLength()) j.setStartAfter(d);
                    else {
                        j.setStartBefore(d);
                        k = 0
                    } else j.setStartBefore(d);
                    if (g && g.type == CKEDITOR.NODE_TEXT) if (e) if (e >= g.getLength()) j.setEndAfter(g);
                    else {
                        j.setEndAfter(g);
                        h = 0
                    ...
                    if (k)(d = j[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(d, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                    if (h) {
                        j.reset();
            ...
            insertNode: function(a) {
                ...
                a.getParent() && a.getParent()
                    .equals(this.endContainer) && this.endOffset++;
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    for (var c = this.createBookmark(), l = this[b ? "endPath" : "startPath"](), d = l.block || l.blockLimit, m; d && !d.equals(l.root) && !d.getFirst(a(d));) {
                        m = d.getParent();
            ...
            moveToElementEditablePosition: function(b, c) {
                ...
                for (var l = 0; b;) {
                    if (b.type == CKEDITOR.NODE_TEXT) {
                        c && this.checkEndOfBlock() && n.test(b.getText()) ? this.moveToPosition(b, CKEDITOR.POSITION_BEFORE_START) : this.moveToPosition(b, c ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START);
                        l = 1;
                        break
                    }
        ...
        b.prototype = {
            getNextParagraph: function(b) {
                ...
                if (!this._.started) {
                    ...
                    o = h.endContainer.hasAscendant("pre", true) || h.startContainer.hasAscendant("pre", true);
                    h.enlarge(this.forceBrBreak && !o || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                    if (!h.collapsed) {
                        o = new CKEDITOR.dom.walker(h.clone());
                        var j = CKEDITOR.dom.walker.bookmark(true, true);
                        o.evaluator = j;
                        this._.nextNode = o.next();
                        o = new CKEDITOR.dom.walker(h.clone());
                        o.evaluator = j;
                        o = o.previous();
                        this._.lastNode = o.getNextSourceNode(true);
                        if (this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent()
                            .isBlockBoundary()) {
                            j = this.range.clone();
                ...
                for (this._.nextNode = null; j;) {
                    var q = 0,
                        C = j.hasAscendant("pre"),
                        x = j.type != CKEDITOR.NODE_ELEMENT,
                        i = 0;
                    if (x) j.type == CKEDITOR.NODE_TEXT && a.test(j.getText()) && (x = 0);
                    else {
                        var s = j.getName();
                        if (j.isBlockBoundary(this.forceBrBreak && !C && {
                            br: 1
                        })) {
                            if (s == "br") x = 1;
                    ...
                    x && h.setEndAt(j, CKEDITOR.POSITION_AFTER_END);
                    j = c(j, i, o);
                    if ((n = !j) || q && h) break
                }
                if (!e) {
                    ...
                    } else if (!n) this._.nextNode = e.equals(o) ? null : c(h.getBoundaryNodes()
                        .endNode, 1, o)
                }
                if (m)(h = e.getPrevious()) && h.type == CKEDITOR.NODE_ELEMENT && (h.getName() == "br" ? h.remove() : h.getLast() && h.getLast()
                    .$.nodeName.toLowerCase() == "br" && h.getLast()
                    .remove());
                if (l)(h = e.getLast()) && h.type == CKEDITOR.NODE_ELEMENT && h.getName() == "br" && (CKEDITOR.env.ie || h.getPrevious(f) || h.getNext(f)) && h.remove();
                if (!this._.nextNode) this._.nextNode = n || e.equals(o) || !o ? null : c(e, 1, o);
                return e
            }
        };
                ...
                if (k === 0) o(true);
                    ...
                    var m = function(a, b) {
                        (b ? h : n)
                            .push(a);
                        if (--k <= 0) {
                            d && CKEDITOR.document.getDocumentElement()
                                .removeStyle("cursor");
                            o(b)
                        }
                    }, l = function(a, l) {
                ...
                b.call(this, a, function(a) {
                    ...
                    for (k in a) {
                        var m = a[k],
                            l = m && m.requires;
                        if (!c[k]) {
                            if (m.icons) for (var j = m.icons.split(","), q = 0; q < j.length; q++) CKEDITOR.skin.addIcon(j[q], m.path + "icons/" + j[q] + ".png");
                            c[k] = 1
                        }
                        if (l) {
                            l.split && (l = l.split(","));
                            for (m = 0; m < l.length; m++) d[l[m]] || b.push(l[m])
                        }
                    }
    ...
    (function() {
        function b(b, j, m) {
            ...
            if (j !== void 0) {
                ...
                if (m == CKEDITOR.ELEMENT_MODE_INLINE && !j.is(CKEDITOR.dtd.$editable) || m == CKEDITOR.ELEMENT_MODE_REPLACE && j.is(CKEDITOR.dtd.$nonBodyContent)) throw Error('The specified element mode is not supported on element: "' + j.getName() + '".');
                this.element = j;
                this.elementMode = m;
        ...
        function h(a) {
            ...
            if (d) var e = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(e, ""),
                c = c + ("," + d);
            if (m) var g = RegExp("(?:^|,)(?:" + m.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(g, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                CKEDITOR.scriptLoader.load(e, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++) for (var g = 0; g < d.length; g++) {
                        var f = d[g];
                        e === 0 && (m[g] && f.lang && f.langEntries) && (a.lang[f.name] = f.langEntries[m[g]]);
                        if (f[c[e]]) f[c[e]](a)
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            elementPath: function(a) {
                return (a = a || this.getSelection()
                    .getStartElement()) ? new CKEDITOR.dom.elementPath(a, this.editable()) : null
            },
            ...
            setKeystroke: function() {
                for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [
                    [].slice.call(arguments, 0)], c, d, m = b.length; m--;) {
                    c = b[m];
                    d = 0;
                ...
                for (var f, e, d = 0, g; f = this._.htmlPartsRegex.exec(a);) {
                    ...
                    if (g) g.push(f[0]);
                        ...
                        if (!/="/.test(e)) {
                            var k = {}, h;
                            f = f[4];
                            var n = !! (f && f.charAt(f.length - 1) == "/");
                            if (f) for (; h = b.exec(f);) {
                                var o = h[1].toLowerCase();
                                h = h[2] || h[3] || h[4] || "";
                                k[o] = !h && c[o] ? o : h
                            }
                            this.onTagOpen(e, k, n);
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(e, d, g) {
            function k(a) {
                var b;
                if (C.length > 0) for (var c = 0; c < C.length; c++) {
                    var d = C[c],
                        l = d.name,
                        j = CKEDITOR.dtd[l],
                        m = i.name && CKEDITOR.dtd[i.name];
                    if ((!m || m[l]) && (!a || !j || j[a] || !CKEDITOR.dtd[a])) {
                        if (!b) {
                            h();
                            b = 1
                        }
            ...
            var j = new CKEDITOR.htmlParser,
                ...
                s = q.name == "textarea",
                A = q.name == "pre";
            j.onTagOpen = function(d, m, g, e) {
                m = new CKEDITOR.htmlParser.element(d, m);
                if (m.isUnknown && g) m.isEmpty = true;
                m.isOptionalClose = e;
                if (b(m)) C.push(m);
                else {
                    if (d == "pre") A = true;
                    ...
                    if (d == "br") x.push(m);
                        ...
                        for (;;) {
                            ...
                            if (!m.isUnknown && !i.isUnknown && !e[d]) if (i.isOptionalClose) j.onTagClose(g);
                            else if (d in a && g in a) {
                                g = i.children;
                                (g = g[g.length - 1]) && g.name == "li" || o(g = new CKEDITOR.htmlParser.element("li"), i);
                                !m.returnPoint && (m.returnPoint = i);
                                i = g
                                ...
                                g in CKEDITOR.dtd.$inline && C.unshift(i);
                                if (i.parent) o(i, i.parent, 1);
                                else {
                                    m.isOrphan = 1;
                                    break
                                }
            ...
            j.onTagClose = function(a) {
                for (var b = C.length - 1; b >= 0; b--) if (a == C[b].name) {
                    C.splice(b, 1);
                    return
                }
                for (var c = [], d = [], m = i; m != q && m.name != a;) {
                    m._.isBlockLike || d.unshift(m);
                    c.push(m);
            ...
            j.onText = function(b) {
                if ((!i._.hasInlineStarted || x.length) && !A && !s) {
            ...
            j.parse(e);
            for (h(!CKEDITOR.env.ie && 1); i != q;) o(i, i.parent, 1);
            n(q);
            return q
        };
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            writeHtml: function(a, b) {
                ...
                this.filterChildren = function() {
                    ...
                    a = a.getHtml();
                    this.children = (new CKEDITOR.htmlParser.fragment.fromHtml(a))
                        .children;
                    c = 1
                };
                b && b.onRoot(this);
    ...
    (function() {
        ...
        function e(a) {
            for (var b = a.type || a instanceof CKEDITOR.htmlParser.fragment, c = 0; c < this.length; c++) {
                if (b) var e = a.type,
                    f = a.name;
                var o = this[c].apply(window, arguments);
                if (o === false) return o;
                if (b) {
                    if (o && (o.name != f || o.type != e)) return o
    ...
    (function() {
        function b(b, c) {
                ...
                return function(l) {
                    if (l.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (g) for (j(g, 1) && e.push(g); g;) {
                            if (d(g) && (i = f(g)) && j(i)) if ((E = f(i)) && !d(E)) e.push(i);
                            else {
                                var q = i,
                                    n = m(t),
                                    k = q.parent.children,
                                    x = CKEDITOR.tools.indexOf(k, q);
                                k.splice(x + 1, 0, n);
                                k = q.next;
                                q.next = n;
                                n.previous = q;
                        ...
                        for (g = 0; g < e.length; g++) h(e[g]);
                        if (e = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(l) !== false : c)) if (!t && CKEDITOR.env.ie && l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) e = false;
            ...
            function j(a, b) {
                ...
                var c;
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(A))) {
                    if (c.index) {
                        g(a, new CKEDITOR.htmlParser.text(a.value.substring(0, c.index)));
                        a.value = c[0]
                    }
                    if (CKEDITOR.env.ie && t && (!b || a.parent.name in q)) return true;
            ...
            var i = {
                ...
                q = CKEDITOR.tools.extend({}, u),
                n;
            for (n in q) "#" in p[n] || delete q[n];
            for (n in q) i.elements[n] = l(t, b.config.fillEmptyBlocks !== false);
            i.root = l(t);
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in c || "data-cke-eol" in c) delete c["data-cke-bogus"];
                            ...
                            var l = f(b);
                            !c && d(b.parent) ? k(b.parent, m(a)) : d(c) && (l && !d(l)) && g(c, m(a))
                        }
                    }
                }
            }(t);
        ...
        function l(a) {
            return a.replace(t, function(a, b, c) {
        ...
        function C(a) {
            return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g, function(a) {
                return "<\!--" + B + "{C}" + encodeURIComponent(a)
                    .replace(/--/g, "%2D%2D") + "--\>"
            })
        }
        function x(a) {
        ...
        function s(a, b) {
            for (var c = [], d = b.config.protectedSource, m = b._.dataStore || (b._.dataStore = {
                id: 1
            }), l = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) {
            ...
            a = a.replace(l, function(a, b, d) {
                return "<\!--" + B + (b ? "{C}" : "") + encodeURIComponent(c[d])
                    .replace(/--/g, "%2D%2D") + "--\>"
            });
            return a.replace(/(['"]).*?\1/g, function(a) {
                ...
                function(a, b) {
                    m[m.id] = decodeURIComponent(b);
                    return "{cke_protected_" + m.id+++"}"
                })
            })
        }
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, d) {
                var a = s(a, this.editor),
                    a = l(a),
                    a = j(a),
                    a = a.replace(z, "$1cke:$2"),
                    a = a.replace(L, "<cke:$1$2></cke:$1>"),
                    a = CKEDITOR.env.opera ? a : a.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                    m = this.editor.editable(),
                    e;
                !b && b !== null && (b = m.getName());
                m = b || m.getName();
                if (CKEDITOR.env.ie && CKEDITOR.env.version < 9 && m == "pre") {
                    m = "div";
                    a = "<pre>" + a + "</pre>";
                    e = 1
                }
                m = this.editor.document.createElement(m);
                m.setHtml("a" + a);
                a = m.getHtml()
                    .substr(1);
                a = a.replace(RegExp(" data-cke-" + CKEDITOR.rnd + "-", "ig"), " ");
                e && (a = a.replace(/^<pre>|<\/pre>$/gi, ""));
                a = a.replace(Q, "$1$2");
                a = q(a);
                a = x(a);
            ...
            toDataFormat: function(a) {
                ...
                d = d.getHtml(true);
                d = x(d);
                return d = i(d, this.editor)
            }
        };
        var A = /(?:&nbsp;|\xa0)$/,
            B = "{cke_protected}",
            p = CKEDITOR.dtd,
            F = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            u = CKEDITOR.tools.extend({}, p.$blockLimit, p.$block),
            r = {
                elements: {},
                attributeNames: [
                    [/^on/, "data-cke-pa-on"]
                ...
                elements: {
                    $: function(a) {
                        ...
                        if (b) {
                            ...
                            for (var c = ["name", "href", "src"], d, m = 0; m < c.length; m++) {
                                d = "data-cke-saved-" + c[m];
                                d in b && delete b[c[m]]
                            }
                        }
                        return a
        ...
        if (CKEDITOR.env.ie) D.attributes.style = function(a) {
        ...
        var t = /<(a|area|img|input|source)\b([^>]*)>/gi,
            w = /\b(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
            I = /(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            G = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            z = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
    ...
    CKEDITOR.htmlParser.cssStyle = function(b) {
        var c = {};
        ((b instanceof CKEDITOR.htmlParser.element ? b.attributes.style : b) || "")
            .replace(/&quot;/g, '"')
            .replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, b, e) {
            ...
            writeHtml: function(c, a) {
                ...
                if (a) {
                    ...
                    for (;;) {
                        ...
                        d = e.name;
                        if (!d) {
                            for (var d = 0, o = this.children.length; d < o; d++) this.children[d].parent = e.parent;
                            this.writeChildrenHtml.call(e, c, n ? null : a);
                            return
                        }
                    }
                    f = e.attributes
                ...
                c.openTag(d, f);
                for (var o = [], m = 0; m < 2; m++) for (g in f) {
                    k = g;
                    h = f[g];
                    if (m == 1) o.push([g, h]);
                    else if (a) {
    ...
    (function() {
        CKEDITOR.inline = function(b, c) {
            ...
            if (b.getEditor()) throw 'The editor instance "' + b.getEditor()
                .name + '" is already attached to the provided element.';
    ...
    (function() {
        function b(b, e, k, h) {
            ...
            if (b.getEditor()) throw 'The editor instance "' + b.getEditor()
                .name + '" is already attached to the provided element.';
            var n = new CKEDITOR.editor(e, b, h);
            h == CKEDITOR.ELEMENT_MODE_REPLACE && b.setStyle("visibility", "hidden");
            k && n.setData(k, null, true);
            n.resetDirty();
            n.on("loaded", function() {
                a(n);
                h == CKEDITOR.ELEMENT_MODE_REPLACE && n.config.autoUpdateElement && f(n);
                n.setMode(n.config.startupMode, function() {
                    n.resetDirty();
        ...
        function a(a) {
            ...
            b = CKEDITOR.dom.element.createFromHtml(e.output({
                ...
                topHtml: n ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + n + "</span>" : "",
                contentId: a.ui.spaceId("contents"),
                bottomHtml: o ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + o + "</span>" : "",
            ...
            f && a.ui.space("contents")
                .setStyle("height", CKEDITOR.tools.cssLength(f));
            ...
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (e.name || e.id) {
                    if (typeof arguments[0] == "string") {
                        if (!RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")
                            .test(e.className)) continue
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, c, e) {
            var f = this.container,
                ...
                m = CKEDITOR.env.webkit && this.document && this.document.getWindow()
                    .$.frameElement,
                e = e ? f.getChild(1) : f;
            e.setSize("width", a, true);
            m && (m.style.width = "1%");
            o.setStyle("height", Math.max(b - (c ? 0 : (e.$.offsetHeight || 0) - (o.$.clientHeight || 0)), 0) + "px");
            m && (m.style.width = "100%");
            this.fire("resize")
        };
    ...
    (function() {
        function b(b) {
            ...
            if (CKEDITOR.env.gecko) {
                var h = e.block || e.blockLimit || e.root,
                    n = h && h.getLast(a);
                h && (h.isBlockBoundary() && (!n || !(n.type == CKEDITOR.NODE_ELEMENT && n.isBlockBoundary())) && !h.is("pre") && !h.getBogus()) && h.appendBogus()
            }
            if (c.config.autoParagraph !== false && i != CKEDITOR.ENTER_BR && g.collapsed && d.equals(f) && !e.block) {
                ...
                if (!e.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) {
                    ...
                    if (CKEDITOR.env.ie)(c = c.getFirst(a)) && (c.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(c.getText())
                        .match(/^(?:&nbsp;|\xa0)$/)) && c.remove();
                    g.select();
                    b.cancel()
                }
        ...
        function e(b) {
            ...
            if (e.contains(f)) {
                ...
                e = function(b, d) {
                    return function(b, m) {
                        m && (b.type == CKEDITOR.NODE_ELEMENT && b.is(f)) && (c = b);
                        if (a(b) && !m && (!d || !g(b))) return false
                    }
                };
                i.guard = e(i);
                i.checkBackward();
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                focus: function() {
                    this.$[CKEDITOR.env.ie && this.getDocument()
                        .equals(CKEDITOR.document) ? "setActive" : "focus"]();
                    CKEDITOR.env.safari && !this.isInline() && (CKEDITOR.document.getActive()
                        .equals(this.getWindow()
                ...
                insertText: function(a) {
                    ...
                    var b = this.editor,
                        c = b.getSelection()
                            .getStartElement()
                            .hasAscendant("pre", true) ? CKEDITOR.ENTER_BR : b.config.enterMode,
                ...
                insertElement: function(b) {
                    d(this);
                    for (var c = this.editor, e = c.config.enterMode, f = c.getSelection(), h = f.getRanges(), n = b.getName(), i = CKEDITOR.dtd.$block[n], o, k, B, p = h.length - 1; p >= 0; p--) {
                        o = h[p];
                        if (!o.checkReadOnly()) {
                            o.deleteContents(1);
                            k = !p && b || b.clone(1);
                            var F, u;
                            if (i) for (;
                            (F = o.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[F.getName()]) && (!u || !u[n]);) if (F.getName() in CKEDITOR.dtd.span) o.splitElement(F);
                            else if (o.checkStartOfBlock() && o.checkEndOfBlock()) {
                                o.setStartBefore(F);
                                o.collapse(true);
                                F.remove()
                            } else o.splitBlock(e == CKEDITOR.ENTER_DIV ? "div" : "p",
                            c.editable());
                            o.insertNode(k);
                            B || (B = k)
                        }
                    ...
                    if (B) {
                        o.moveToPosition(B, CKEDITOR.POSITION_AFTER_END);
                        if (i) if ((b = B.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block)) b.getDtd()["#"] ? o.moveToElementEditStart(b) : o.moveToElementEditEnd(B);
                        else if (!b && e != CKEDITOR.ENTER_BR) {
                            b = o.fixBlock(true, e == CKEDITOR.ENTER_DIV ? "div" : "p");
                ...
                setup: function() {
                    ...
                    this.on("blur", function(a) {
                        CKEDITOR.env.opera && CKEDITOR.document.getActive()
                            .equals(this.isInline() ? this : this.getWindow()
                            .getFrame()) ? a.cancel() : this.hasFocus = false
                    }, null, null, - 1);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in {
                                ...
                                if (l = e(l)) {
                                    ...
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if (b.collapsed) if ((j = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (n = j[c ? "getPrevious" : "getNext"](h)) && n.is("table")) {
                                    a.fire("saveSnapshot");
                                    b[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && j.remove();
                                    b["moveToElementEdit" + (c ? "End" : "Start")](n);
                                    b.select();
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if (f.blockLimit && f.blockLimit.is("td") && (g = f.blockLimit.getAscendant("table")) && b.checkBoundaryOfElement(g, c ? CKEDITOR.START : CKEDITOR.END) && (n = g[c ? "getPrevious" : "getNext"](h))) {
                                    a.fire("saveSnapshot");
                                    b["moveToElementEdit" + (c ? "End" : "Start")](n);
                                    b.checkStartOfBlock() && b.checkEndOfBlock() ? n.remove() : b.select();
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if ((g = f.contains(["td", "th", "caption"])) && b.checkBoundaryOfElement(g, c ? CKEDITOR.START : CKEDITOR.END)) if ((n = g[c ? "getPreviousSourceNode" : "getNextSourceNode"](1, CKEDITOR.NODE_ELEMENT)) && !n.isReadOnly() && b.root.contains(n)) {
                                    b[c ? "moveToElementEditEnd" : "moveToElementEditStart"](n);
                                    b.select();
                                    d = 1
                                }
                            }
                        ...
                        if (CKEDITOR.env.webkit) {
                            this.attachListener(this, "click", function(a) {
                                a.data.getTarget()
                                    .is("input", "select") && a.data.preventDefault()
                            });
                            this.attachListener(this, "mouseup", function(a) {
                                a.data.getTarget()
                                    .is("input", "textarea") && a.data.preventDefault()
                            })
                        }
                    }
                }
        ...
        var o = function() {
            ...
            function c(a, d) {
                var e, f, j, g, t = [],
                    n = d.range.startContainer;
                e = d.range.startPath();
                for (var n = i[n.getName()], h = 0, o = a.getChildren(), q = o.count(), k = -1, x = -1, C = 0, s = e.contains(i.$list); h < q; ++h) {
                    e = o.getItem(h);
                    if (b(e)) {
                        j = e.getName();
                        if (s && j in CKEDITOR.dtd.$list) t = t.concat(c(e, d));
                            ...
                            g = !! n[j];
                            if (j == "br" && e.data("cke-eol") && (!h || h == q - 1)) {
                                C = (f = h ? t[h - 1].node : o.getItem(h + 1)) && (!b(f) || !f.is("br"));
            ...
            function f(a, c, d, e) {
                ...
                if ((j = (new CKEDITOR.dom.walker(l))
                    .next()) && b(j) && h[j.getName()] && (g = j.getPrevious()) && b(g) && !g.getParent()
                    .equals(a.startContainer) && d.contains(g) && e.contains(j) && j.isIdentical(g)) {
                    j.moveChildren(g);
                    j.remove();
                    f(a, c, d, e)
                }
            ...
            delete k.br;
            return function(h, s, u) {
                var r = h.editor;
                h.getDocument();
                var D = r.getSelection()
                    .getRanges()[0];
                if (!D.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(D.startContainer, D.root))
                        .blockLimit || D.root,
                        s = {
                            type: s,
                            editable: h,
                    ...
                    for (;
                    (z = b(r.startContainer) && r.startContainer.getChild(r.startOffset - 1)) && b(z) && z.isBlockBoundary() && I.contains(z);) r.moveToPosition(z, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    if (u) {
                        ...
                        if (s.type == "text" && s.inlineStylesRoot) {
                            w = z;
                            z = s.inlineStylesPeak;
                            r = z.getDocument()
                                .createText("{cke-peak}");
                            for (v = s.inlineStylesRoot.getParent(); !z.equals(v);) {
                                r = r.appendTo(z.clone());
                                z = z.getParent()
                            }
                            z = r.getOuterHtml()
                                .replace("{cke-peak}",
                        ...
                        if (/^\s+|\s+$/.test(z) && "span" in CKEDITOR.dtd[w]) {
                            var L = '<span data-cke-marker="1">&nbsp;</span>';
                            z = L + z + L
                        }
                        z = s.editor.dataProcessor.toHtml(z, null, false);
                        ...
                        if ((L = u.startPath()
                            .block) && !(L.getChildCount() == 1 && L.getBogus())) a: {
                            var E;
                            if (w.getChildCount() == 1 && b(E = w.getFirst()) && E.is(o)) {
                        ...
                        for (n(I, E); w < I.length; w++) {
                            ...
                            if (y = G.isLineBreak) {
                                ...
                                if (G.hasBlockSibling) y = 1;
                                    ...
                                    M = y.startContainer.getAscendant(i.$block, 1);
                                    if (!M || !M.is({
                                        div: 1,
                                        p: 1
                                    })) y = 0;
                            ...
                            if (y) v = w > 0;
                                ...
                                y = E.startPath();
                                if (!G.isBlock && (N = s.editor.config.enterMode != CKEDITOR.ENTER_BR && s.editor.config.autoParagraph !== false ? s.editor.config.enterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false) && !y.block && y.blockLimit && y.blockLimit.equals(E.root)) {
                                    N = L.createElement(N);
                                ...
                                if (r && G.isElement) {
                                    y = E.startContainer;
                                    for (K = null; y && !i[y.getName()][G.name];) {
                                        if (y.equals(u)) {
                                            y = null;
                                            break
                                        }
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            f.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && l.attachListener(l, "focus", function(a) {
                    ...
                    if (o !== 0) {
                        a = f.getSelection()
                            .getNative();
                        if (a.isCollapsed && a.anchorNode == l.$) {
                            a = f.createRange();
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.opera || h) {
                    ...
                    n ? l.attachListener(l, "beforedeactivate", F, null, null, - 1) : l.attachListener(f, "selectionCheck", F, null, null, - 1);
                        ...
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) m.on("mousedown", function(a) {
                            function b(a) {
                                ...
                                if (d) {
                                    ...
                                    d.setEndPoint(l.compareEndPoints("StartToStart",
                            ...
                            a = a.data;
                            if (a.getTarget()
                                .is("html") && a.$.y < m.$.clientHeight && a.$.x < m.$.clientWidth) {
                        ...
                        if (CKEDITOR.env.version > 7) {
                            ...
                            var r = function() {
                                ...
                                var b = CKEDITOR.document.$.selection,
                                    c = b.createRange();
                                b.type != "None" && c.parentElement()
                                    .ownerDocument == a.$ && c.select()
                            }
                        }
                    }
                }
                ...
                if (h ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                    var D;
                    l.attachListener(l, "mousedown", function() {
                        D = 1
                    });
                ...
                } else l.attachListener(CKEDITOR.env.ie ? l : a.getDocumentElement(), "mouseup", c, f);
            ...
            CKEDITOR.env.ie9Compat && f.on("beforeDestroy", e, null,
            null, 9);
            ...
            if (CKEDITOR.env.webkit) {
                ...
                var f, g, a = function() {
                    ...
                    if (d) {
                        d.setText(f);
                        if (g) {
                            a.$.defaultView.getSelection()
                                .setPosition(d.$, d.getLength());
                            g = 0
                        }
                    }
                };
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (CKEDITOR.env.webkit) {
                a = this.document.getWindow()
                    .$.getSelection();
                if (a.type == "None" && this.document.getActive()
                    .equals(this.root) || a.type == "Caret" && a.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) {
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function() {
                return this._.cache.nativeSel !== void 0 ? this._.cache.nativeSel : this._.cache.nativeSel = n ? this.document.$.selection : this.document.getWindow()
                    .$.getSelection()
            },
            getType: n ? function() {
                var a = this._.cache;
                ...
                try {
                    ...
                    if (c.createRange()
                        .parentElement()) b = CKEDITOR.SELECTION_TEXT
                } catch (e) {}
                return a.type = b
            } : function() {
                var a = this._.cache;
            ...
            getRanges: function() {
                var a = n ? function() {
                        ...
                        var b = function(b, c) {
                            ...
                            for (var f = d.children, g, j, m = b.duplicate(), h = 0, n = f.length - 1, o = -1, k, v; h <= n;) {
                                o = Math.floor((h + n) / 2);
                                g = f[o];
                                m.moveToElementText(g);
                                k = m.compareEndPoints("StartToStart", b);
                                if (k > 0) n = o - 1;
                                else if (k < 0) h = o + 1;
                                else {
                            ...
                            m.collapse(k > 0 ? true : false);
                            m.setEndPoint(k > 0 ? "StartToStart" : "EndToStart", b);
                            e = m.text.replace(/(\r\n|\r)/g, "\n")
                                .length;
                            if (!e) return {
                                container: d,
                    ...
                    if (b) for (var d = c.ranges, e = 0; e < d.length; e++) {
                        ...
                        if (!f.collapsed) {
                            ...
                            var h = f.startOffset,
                                n = f.endOffset,
                                o = f.clone();
                            b && b.type == CKEDITOR.NODE_TEXT && (h >= b.getLength() ? o.setStartAfter(b) : o.setStartBefore(b));
                            g && g.type == CKEDITOR.NODE_TEXT && (n ? o.setEndAfter(g) : o.setEndBefore(g));
                            b = new CKEDITOR.dom.walker(o);
                            b.evaluator = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && a.isReadOnly()) {
                                    var b = f.clone();
                                    f.setEndBefore(a);
                                    f.collapsed && d.splice(e--, 1);
                                    if (!(a.getPosition(o.endContainer) & CKEDITOR.POSITION_CONTAINS)) {
                                        b.setStartAfter(a);
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() {
                        ...
                        for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && o[c.getName()] && (d = c))); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                        return d.$
                    });
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = n ? b.type == "Control" ? "" : b.createRange()
                        .text : b.toString();
            ...
            selectRanges: function(a) {
                if (a.length) if (this.isLocked) {
                    ...
                    if (n) {
                        ...
                        if (A && A.type == CKEDITOR.NODE_ELEMENT && A.getName() in o && (!A.is("a") || !A.getText())) try {
                        ...
                        if (p) {
                            ...
                            h = !(h && h.getText && h.getText()
                                .match(e)) && (i || !g.hasPrevious() || g.getPrevious()
                                .is && g.getPrevious()
                                .is("br"));
                            i = b.document.createElement("span");
                            i.setHtml("&#65279;");
                            i.insertBefore(g);
                            h && b.document.createText("﻿")
                                .insertBefore(g)
                        }
                        b.setStartBefore(g);
                        g.remove();
                        ...
                        for (e = 0; e < a.length; e++) {
                            ...
                            if (b.collapsed && CKEDITOR.env.webkit && f(b)) {
                                ...
                                b.insertNode(i);
                                if ((h = i.getNext()) && !i.getPrevious() && h.type == CKEDITOR.NODE_ELEMENT && h.getName() == "br") {
                                    d(this.root);
                            ...
                            try {
                                ...
                                if (F.toString()
                                    .indexOf("NS_ERROR_ILLEGAL_VALUE") >= 0) {
                                    b.collapse(1);
                                    k.setEnd(b.endContainer.$, b.endOffset)
                                } else throw F;
                            }
    ...
    (function() {
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                var j = CKEDITOR.dtd[d] || (f = true, CKEDITOR.dtd.span);
                ...
                for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
                    ...
                    if (m.equals(o)) {
                        ...
                        var p = m.type,
                            r = p == CKEDITOR.NODE_ELEMENT ? m.getName() : null,
                            q = r && m.getAttribute("contentEditable") == "false",
                            s = r && m.getAttribute("data-nostyle");
                        if (r && m.data("cke-bookmark")) {
                            m = m.getNextSourceNode(true);
                            continue
                        }
                        if (!r || j[r] && !s && (!q || h) && (m.getPosition(o) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(m))) {
                            var u = m.getParent();
                            if (u && ((u.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(u))) {
                                if (!k && (!r || !CKEDITOR.dtd.$removeEmpty[r] || (m.getPosition(o) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED)) {
                                    k = a.clone();
                                    k.setStartBefore(m)
                                }
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                    for (var p = m, v;
                                    (g = !p.getNext(D)) && (v = p.getParent(), j[v.getName()]) && (v.getPosition(i) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(v));) p = v;
                                    k.setEndAfter(p)
                                }
                            } else g = true
                        } else g = true;
                        m = m.getNextSourceNode(s || q && !h)
                    }
                    if (g && k && !k.collapsed) {
                        for (var g = C(this, c), q = g.hasAttributes(), s = k.getCommonAncestor(), p = {}, r = {}, u = {}, x = {}, A, B, F; g && s;) {
                            if (s.getName() == d) {
                                for (A in e.attributes) if (!x[A] && (F = s.getAttribute(B))) g.getAttribute(A) == F ? r[A] = 1 : x[A] = 1;
                                for (B in e.styles) if (!u[B] && (F = s.getStyle(B))) g.getStyle(B) == F ? p[B] = 1 : u[B] = 1
                            }
                            s = s.getParent()
                        }
        ...
        function a(a) {
            ...
            if (a.collapsed) {
                for (var d = new CKEDITOR.dom.elementPath(c.getParent(), a.root), e, f = 0, g; f < d.elements.length && (g = d.elements[f]); f++) {
                    ...
                    if (this.checkElementRemovable(g)) {
                        ...
                        if (a.collapsed && (a.checkBoundaryOfElement(g, CKEDITOR.END) || (h = a.checkBoundaryOfElement(g, CKEDITOR.START)))) {
                            ...
                            g.mergeSiblings();
                            g.getName() == this.element ? m.call(this, g) : j(g, s(this)[g.getName()])
                        }
                    }
                }
                if (e) {
                ...
                var n = b.endNode,
                    l = this,
                    d = function() {
                        for (var a = new CKEDITOR.dom.elementPath(c.getParent()), b = new CKEDITOR.dom.elementPath(n.getParent()), d = null, e = null, f = 0; f < a.elements.length; f++) {
                            var g = a.elements[f];
                ...
                for (e = c; !e.equals(n);) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) {
                        e.getName() == this.element ? m.call(this, e) : j(e, s(this)[e.getName()]);
        ...
        function f(a) {
            ...
            (a = (new CKEDITOR.dom.elementPath(b, a.root))
                .contains(this.element, 1)) && !a.isReadOnly() && x(a, this)
        }
        function e(a) {
            var b = a.getCommonAncestor(true, true);
            if (a = (new CKEDITOR.dom.elementPath(b, a.root))
                .contains(this.element, 1)) {
        ...
        function k(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else f ? b = o(c ? [a.getHtml()] : h(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b,
                    j;
        ...
        function l(a) {
            for (var b = s(this), c = a.getElementsByTag(this.element), d = c.count(); --d >= 0;) m.call(this, c.getItem(d));
        ...
        CKEDITOR.style = function(a, b) {
            ...
            this.type = a.type || (p[c] ? CKEDITOR.STYLE_BLOCK : F[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function(a) {
                return (this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? d : this.type == CKEDITOR.STYLE_OBJECT ? f : null)
                    .call(this, a)
            },
            removeFromRange: function(b) {
                return (this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? a : this.type == CKEDITOR.STYLE_BLOCK ? g : this.type == CKEDITOR.STYLE_OBJECT ? e : null)
                    .call(this, b)
            },
    ...
    CKEDITOR.editor.prototype.getStylesSet = function(b) {
        if (this._.stylesDefinitions) b(this._.stylesDefinitions);
            ...
            if (a instanceof Array) {
                ...
                var a = a.split(":"),
                    f = a[0];
                CKEDITOR.stylesSet.addExternal(f, a[1] ? a.slice(1)
                    .join(":") : CKEDITOR.getUrl("styles.js"), "");
    ...
    CKEDITOR.dom.elementPath.prototype = {
        ...
        direction: function() {
            return (this.block || this.blockLimit || this.root)
                .getDirection(1)
        }
    };
    ...
    (function() {
        function b(a, b, c) {
            ...
            if (g.equals(h.getPrevious())) {
                b.startOffset = b.startOffset - g.getLength() - a.getPrevious()
                    .getLength();
                g = a.getNext()
                ...
                return {
                    getNextRange: function(g) {
                        ...
                        if (k && a.length > 1) {
                            ...
                            if (g) for (var n = 0; a[d + n + 1];) {
                                for (var o = k.document, g = 0, h = o.getById(c[n].endNode), o = o.getById(c[n + 1].startNode);;) {
                            ...
                            for (k.moveToBookmark(c.shift()); n--;) {
                                h = a[++d];
        ...
        onLoad: function() {
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                ...
                select: function(b, a, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                            ...
                            p(c);
                            for (var k = 0, j; k < a.items.length && (j = a.items[k]); k++) i.push('<option value="', CKEDITOR.tools.htmlEncode(j[1] !== void 0 ? j[1] : j[0])
                                .replace(/"/g, "&quot;"), '" /> ', CKEDITOR.tools.htmlEncode(j[0]));
                            if (typeof c.inputStyle != "undefined") c.style = c.inputStyle;
                ...
                file: function(b, a, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        a.validate && (this.validate = a.validate);
                        b.on("load", function() {
                            CKEDITOR.document.getById(e.frameId)
                                .getParent()
                ...
                fileButton: function(b, a, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        b.on("load", function() {
                            b.getContentElement(a["for"][0], a["for"][1])
                                ._.buttons.push(e)
                        });
            ...
            CKEDITOR.ui.dialog.labeledElement.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                setLabel: function(b) {
                    ...
                    1 > a.getChildCount() ? (new CKEDITOR.dom.text(b, CKEDITOR.document))
                        .appendTo(a) : a.getChild(0)
                        .$.nodeValue = b;
                    return this
                },
                getLabel: function() {
                    var b = CKEDITOR.document.getById(this._.labelId);
                    return !b || 1 > b.getChildCount() ? "" : b.getChild(0)
                        .getText()
                },
                eventProcessors: o
            }, !0);
            ...
            CKEDITOR.ui.dialog.select.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
                ...
                add: function(b, a, d) {
                    var e = new CKEDITOR.dom.element("option", this.getDialog()
                        .getParentEditor()
                        .document),
            ...
            CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                setValue: function(b, a) {
                    for (var d = this._.children, e, c = 0; c < d.length && (e = d[c]); c++) e.getElement()
                        .$.checked = e.getValue() == b;
                    !a && this.fire("change", {
                        value: b
                    })
                },
                getValue: function() {
                    for (var b = this._.children, a = 0; a < b.length; a++) if (b[a].getElement()
                ...
                eventProcessors: {
                    onChange: function(b, a) {
                        if (CKEDITOR.env.ie) b.on("load", function() {
                            for (var a = this._.children, b = this, c = 0; c < a.length; c++) a[c].getElement()
                                .on("propertychange", function(a) {
                                a = a.data.$;
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, n, {
                getInputElement: function() {
                    var b = CKEDITOR.document.getById(this._.frameId)
                        .getFrameDocument();
                ...
                reset: function() {
                    ...
                    var a = this._,
                        d = CKEDITOR.document.getById(a.frameId)
                            .getFrameDocument(),
                        e = a.definition,
                        c = a.buttons,
    ...
    (function() {
        ...
        function q(a, b) {
            ...
            e = 0, d = c.length; e < d; e++) {
                ...
                "text" == g.getAttribute("type")
                    .toLowerCase() && (b ? (g.setAttribute("value", g.getCustomData("fake_value") || ""), g.removeCustomData("fake_value")) : (g.setCustomData("fake_value", g.getAttribute("value")), g.setAttribute("value", "")))
            }
        }
        function P(a, b) {
        ...
        function R(a) {
            var a = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", S)
                .output({
            ...
            if (CKEDITOR.env.ie && !CKEDITOR.env.ie6Compat) {
                ...
                CKEDITOR.dom.element.createFromHtml('<iframe frameBorder="0" class="cke_iframe_shim" src="' + d + '" tabIndex="-1"></iframe>')
                    .appendTo(b.getParent())
            }
            c.unselectable();
            e.unselectable();
            return {
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                var k = a.getParentEditor(),
                    m, j, h, o, i, n = CKEDITOR.tools.addFunction(function(f) {
                        ...
                        g.$.getElementsByTagName("iframe")
                            .length && (i = CKEDITOR.dom.element.createFromHtml('<div class="cke_dialog_resize_cover" style="height: 100%; position: absolute; width: 100%;"></div>'), g.append(i));
                        ...
                        CKEDITOR.env.ie6Compat && (g = r.getChild(0)
                            .getFrameDocument(), g.on("mousemove", e), g.on("mouseup", d));
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            this.on("iframeAdded", function(a) {
                (new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document))
                    .on("keydown",
                d, this, null, 0)
            });
            this.on("show", function() {
            ...
            U(this);
            V(this);
            (new CKEDITOR.dom.text(f.title, CKEDITOR.document))
                .appendTo(this.parts.title);
        ...
        CKEDITOR.dialog.prototype = {
            ...
            resize: function() {
                return function(a, b) {
                    if (!this._.contentSize || !(this._.contentSize.width == a && this._.contentSize.height == b)) CKEDITOR.dialog.fire("resize", {
                        ...
                        width: a + "px",
                        height: b + "px"
                    }), "rtl" == this._.editor.lang.dir && this._.position && (this._.position.x = CKEDITOR.document.getWindow()
                        .getViewPaneSize()
                        .width - this._.contentSize.width - parseInt(this._.element.getFirst()
                        .getStyle("right"), 10)), this._.contentSize = {
                        width: a,
                        height: b
                    }
                }
            ...
            move: function(a, b, c) {
                ...
                if (!g || !this._.position || !(this._.position.x == a && this._.position.y == b)) this._.position = {
                    x: a,
                    y: b
                }, g || (g = CKEDITOR.document.getWindow()
                    .getScrollPosition(), a += g.x, b += g.y), d && (g = this.getSize(), a = CKEDITOR.document.getWindow()
                    .getViewPaneSize()
                    .width - g.width - a), b = {
                    top: (0 < b ? b : 0) + "px"
            ...
            show: function() {
                var a = this._.element,
                    b = this.definition;
                !a.getParent() || !a.getParent()
                    .equals(CKEDITOR.document.getBody()) ? a.appendTo(CKEDITOR.document.getBody()) : a.setStyle("display", "block");
                ...
                this._.element.getFirst()
                    .setStyle("z-index", CKEDITOR.dialog._.currentZIndex += 10);
                null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, J(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, this._.parentDialog.getElement()
                    .getFirst()
                    .$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), CKEDITOR.dialog._.currentTop = this);
                a.on("keydown", M);
            ...
            commitContent: function() {
                var a = arguments;
                this.foreach(function(b) {
                    CKEDITOR.env.ie && this._.currentFocusIndex == b.focusIndex && b.getInputElement()
                        .$.blur();
            ...
            hide: function() {
                if (this.parts.dialog.isVisible()) {
                    ...
                    if (this._.parentDialog) {
                        var b = this._.parentDialog.getElement()
                            .getFirst();
            ...
            getValueOf: function(a, b) {
                return this.getContentElement(a, b)
                    .getValue()
            },
                ...
                b, c, e, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, d || {
                            ...
                            b.push('"');
                            b.push('align="', CKEDITOR.tools.htmlEncode(d && d.align || ("ltr" == a.getParentEditor()
                                .lang.dir ? "left" : "right")), '" ');
                            b.push("><tbody>");
                            for (var e = 0; e < c.length; e++) {
                                var h = [];
        ...
        function m(a) {
            return {
                ...
                refresh: function(a, d) {
                    ...
                    c.equals(a.editable()) && (h = a.getSelection()
                        .getRanges()[0].getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT && (c = h);
                    c && (b = b ? c.getComputedStyle("direction") : c.getStyle("direction") || c.getAttribute("dir"), a.getCommand("bidirtl")
                        .setState("rtl" == b ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF),
                    a.getCommand("bidiltr")
                        .setState("ltr" == b ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF));
                    b = (d.block || d.blockLimit || a.editable())
                        .getDirection(1);
                    ...
                    if (c && c.length) {
                        for (var h = {}, e = d.createBookmarks(), c = c.createIterator(), g, j = 0; g = c.getNextRange(1);) {
                            ...
                            k.evaluator = function(a) {
                                return !!(a.type == CKEDITOR.NODE_ELEMENT && a.getName() in p && !(a.getName() == (b == CKEDITOR.ENTER_P ? "p" : "div") && a.getParent()
                                    .type == CKEDITOR.NODE_ELEMENT && "blockquote" == a.getParent()
                                    .getName()) && a.getPosition(l) & CKEDITOR.POSITION_FOLLOWING && (a.getPosition(m) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_CONTAINS) == CKEDITOR.POSITION_PRECEDING)
                            };
        ...
        function s(a) {
            ...
            return function(c, h) {
                if (!this.isReadOnly()) {
                    ...
                    if (e && (e = this.getDirection(1), g = a.apply(this, arguments), e != this.getDirection(1))) return this.getDocument()
                        .fire("dirChanged", this), g
                }
                return a.apply(this, arguments)
            }
        }
    ...
    (function() {
        var k = {
                ...
                if (c) {
                    ...
                    if (CKEDITOR.env.ie) {
                        var e = h[0].startNode,
                            b = h[0].endNode,
                            d;
                        if (e && "blockquote" == e.getParent()
                            .getName()) for (d = e; d = d.getNext();) if (d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary()) {
                            e.move(d, !0);
                            break
                        }
                        if (b && "blockquote" == b.getParent()
                            .getName()) for (d = b; d = d.getPrevious();) if (d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary()) {
                            b.move(d);
                            break
                        }
                    }
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (b = null; 0 < e.length;) {
                            for (a = e.shift(); !a.getParent()
                                .equals(d);) a = a.getParent();
                            a.equals(b) || c.push(a);
                            b = a
                        }
                        for (; 0 < c.length;) if (a = c.shift(), "blockquote" == a.getName()) {
                            for (b = new CKEDITOR.dom.documentFragment(g.document); a.getFirst();) b.append(a.getFirst()
                                .remove()), e.push(b.getLast());
                            b.replace(a)
                        } else e.push(a);
                        ...
                        a = [];
                        e = [];
                        for (d = {}; 0 < b.length;) f = b.shift(), c = f.getParent(), f.getPrevious() ? f.getNext() ? (f.breakParent(f.getParent()), e.push(f.getNext())) : f.remove()
                            .insertAfter(c) : f.remove()
                            .insertBefore(c), c.getCustomData("blockquote_processed") || (e.push(c), CKEDITOR.dom.element.setMarker(d, c, "blockquote_processed", !0)), a.push(f);
                        CKEDITOR.dom.element.clearAllMarkers(d);
                        ...
                        if (g.config.enterMode == CKEDITOR.ENTER_BR) for (c = !0; a.length;) if (f = a.shift(), "div" == f.getName()) {
                            ...
                            c && (f.getPrevious() && !(f.getPrevious()
                                .type == CKEDITOR.NODE_ELEMENT && f.getPrevious()
                                .isBlockBoundary())) && b.append(g.document.createElement("br"));
                            for (c = f.getNext() && !(f.getNext()
                                .type == CKEDITOR.NODE_ELEMENT && f.getNext()
                                .isBlockBoundary()); f.getFirst();) f.getFirst()
                                .remove()
                                .appendTo(b);
            ...
            refresh: function(g, a) {
                this.setState(g.elementPath(a.block || a.blockLimit)
                    .contains("blockquote", 1) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF)
            },
            context: "blockquote"
        };
    ...
    (function() {
        function v(b) {
            function a() {
                ...
                (CKEDITOR.env.ie ? e : b.document.getDocumentElement())
                    .on("mouseup", function() {
                    setTimeout(function() {
                        s()
                    }, 0)
            ...
            function l(e) {
                ...
                c.on(e, j);
                (7 < CKEDITOR.env.version ? a.$ : a.$.selection.createRange())
                    .execCommand(e);
            ...
            function k(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    var g = 0,
                        d = d.getWindow();
                    f ? (i.insertAfter(o[0].startNode), i.setStyle("display", "inline")) : (CKEDITOR.env.webkit ? (j.append(i), i.addClass("cke_editable"), g = (j.is("body") ? j : CKEDITOR.dom.element.get(i.$.offsetParent))
                        .getDocumentPosition()
                        .y) : j.getAscendant(CKEDITOR.env.ie || CKEDITOR.env.opera ? "body" : "html", 1)
                        .append(i), i.setStyles({
                        position: "absolute",
                        top: d.getScrollPosition()
                            .y - g + 10 + "px",
                        width: "1px",
                        height: Math.max(1, d.getViewPaneSize()
                            .height - 20) + "px",
                        overflow: "hidden",
                        margin: 0,
                        padding: 0
                    ...
                    (f = i.getParent()
                        .isReadOnly()) ? (i.setOpacity(0), i.setAttribute("contenteditable", !0)) : i.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-1000px");
                    ...
                    var n = CKEDITOR.document.getWindow()
                        ...
                        .y;
                    setTimeout(function() {
                        if (CKEDITOR.env.webkit || CKEDITOR.env.opera) CKEDITOR.document[CKEDITOR.env.webkit ? "getBody" : "getDocumentElement"]()
                            .$.scrollTop = n;
                        m && m.removeListener();
            ...
            function o() {
                if (CKEDITOR.env.ie) {
                    ...
                    a.lock();
                    if (b.editable()
                        .fire(q) && !l("paste")) return a.unlock(), !1;
                    a.unlock()
                } else try {
                    if (b.editable()
            ...
            function n(a) {
                ...
                if ("Paste" == a) {
                    ...
                    m = 0
                } else a = b.getSelection(), c = a.getRanges(), c = a.getType() != CKEDITOR.SELECTION_NONE && !(1 == c.length && c[0].collapsed);
        ...
        function x(b, a) {
            ...
            if (a.match(/^[^<]$/)) return a;
            CKEDITOR.env.webkit && -1 < a.indexOf("<div>") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>")
                .replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), a.match(/<div>(<br>|)<\/div>/) && (a = "<p>" + a.replace(/(<div>(<br>|)<\/div>)+/g, function(a) {
                return d(a.split("</div><div>")
                    .length + 1)
        ...
        function z(b, a, d) {
            ...
            a.writeHtml(c, d);
            var a = c.getHtml(),
                a = a.replace(/\s*(<\/?[a-z:]+ ?\/?>)\s*/g, "$1")
                    .replace(/(<cke:br \/>){2,}/g, "<cke:br />")
                    .replace(/(<cke:br \/>)(<\/?p>|<br \/>)/g, "$2")
    ...
    (function() {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(b, e) {
                ...
                if (this.directional) b.on("contentDirChanged", function(a) {
                    var e = CKEDITOR.document.getById(this._.id),
                        c = e.getFirst(),
                        a = a.data;
                    a != b.lang.dir ? e.addClass("cke_" + a) : e.removeClass("cke_ltr")
                        .removeClass("cke_rtl");
                ...
                a = {
                    ...
                    state: f,
                    title: this.title,
                    titleJs: a.gecko && 10900 <= a.version && !a.hc ? "" : (this.title || "")
                        .replace("'", ""),
            ...
            setState: function(b) {
                ...
                return a ? (a.setState(b, "cke_button"), b == CKEDITOR.TRISTATE_DISABLED ? a.setAttribute("aria-disabled", !0) : a.removeAttribute("aria-disabled"), b == CKEDITOR.TRISTATE_ON ? a.setAttribute("aria-pressed", !0) : a.removeAttribute("aria-pressed"), !0) : !1
            }
        };
                ...
                proto: {
                    createPanel: function(c) {
                        ...
                        if (!a.panel) {
                            ...
                            d.onHide = function(d) {
                                b.className && this.element.getFirst()
                                    .removeClass(b.className + "_panel");
    ...
    (function() {
                        ...
                        if (this.isFramed) {
                            ...
                            a.on("key" + (CKEDITOR.env.opera ? "press" : "down"), function(a) {
                                var b = a.data.getKeystroke(),
                                    c = this.document.getById(this.id)
                                        .getAttribute("dir");
        ...
        CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
            $: function(a, b) {
                this.element = a.append(a.getDocument()
                    .createElement("div", {
                    attributes: {
                        tabIndex: -1,
            ...
            _: {
                markItem: function(a) {
                    -1 != a && (a = this.element.getElementsByTag("a")
                        .getItem(this._.focusIndex = a), (CKEDITOR.env.webkit || CKEDITOR.env.opera) && a.getDocument()
                        .getWindow()
                        .focus(), a.focus(), this.onMark && this.onMark(a))
                }
            },
            proto: {
                show: function() {
                ...
                onKeyDown: function(a) {
                    ...
                    case "click":
                    case "mouseup":
                        return a = this._.focusIndex, (c = 0 <= a && this.element.getElementsByTag("a")
                            .getItem(a)) && (c.$[b] ? c.$[b]() : c.$["on" + b]()), !1
                    }
                    return !0
                }
            }
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            ...
            proto: {
                        ...
                        var a = CKEDITOR.tools.bind(function() {
                            ...
                            if (k.autoSize) {
                                var a = k.element.getDocument(),
                                    a = (CKEDITOR.env.webkit ? k.element : a.getBody())
                                        .$.scrollWidth;
                                ...
                                e._.currentBlock.element.setStyle("display", "none")
                                    .removeStyle("display")
                            ...
                            if (CKEDITOR.env.ie) {
                                ...
                                b.getName() == "html" && (b = b.getDocument()
                                    .getBody());
                                b.getComputedStyle("direction") == "rtl" && (f = CKEDITOR.env.ie8Compat ? f - d.getDocument()
                                    .getDocumentElement()
                                    .$.scrollLeft * 2 : f - (a.$.scrollWidth - a.$.clientWidth))
                            }
                            var a = d.getFirst(),
                                j;
                ...
                focus: function() {
                    ...
                    }(this._.lastFocused || this._.iframe.getFrameDocument()
                        .getWindow())
                        .focus()
                },
                blur: function() {
                    var a = this._.iframe.getFrameDocument()
                        .getActive();
                ...
                hide: function(a) {
                    if (this.visible && (!this.onHide || !0 !== this.onHide.call(this))) {
                        this.hideChild();
                        CKEDITOR.env.gecko && this._.iframe.getFrameDocument()
                            .$.activeElement.blur();
                        this.element.setStyle("display", "none");
                        this.visible = 0;
                        this.element.getFirst()
                            .removeCustomData("activePanel");
                        if (a = a && this._.returnFocus) CKEDITOR.env.webkit && a.type && a.getWindow()
                            .$.focus(),
                        a.focus();
    ...
    CKEDITOR.plugins.add("colorbutton", {
        ...
        init: function(c) {
            function j(k, i, e, g) {
                ...
                c.ui.add(k, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    onOpen: function() {
                        ...
                        this._.panel._.iframe.getFrameDocument()
                            .getById(h)
            ...
            function n(k, i, e) {
                        ...
                        if ("?" == a) {
                            var e = arguments.callee,
                                d = function(a) {
                                    ...
                                    "ok" == a.name && e(this.getContentElement("picker", "selectedColor")
                                        .getValue(), b)
                                };
                            ...
                            if (a) {
                                ...
                                f.childRule = "back" == b ? function(a) {
                                    ...
                                    return !(a.is("a") || a.getElementsByTag("a")
                                        .count()) || m(a)
                                };
                ...
                g.push('<a class="cke_colorauto" _cke_focus=1 hidefocus=true title="', f.auto, '" onclick="CKEDITOR.tools.callFunction(', b, ",null,'", i, "');return false;\" href=\"javascript:void('", f.auto, '\')" role="option"><table role="presentation" cellspacing=0 cellpadding=0 width="100%"><tr><td><span class="cke_colorbox" id="',
                e, '"></span></td><td colspan=7 align=center>', f.auto, '</td></tr></table></a><table role="presentation" cellspacing=0 cellpadding=0 width="100%">');
                for (e = 0; e < j.length; e++) {
                    ...
                    g.push('<td><a class="cke_colorbox" _cke_focus=1 hidefocus=true title="', a, '" onclick="CKEDITOR.tools.callFunction(', b, ",'", d, "','", i, "'); return false;\" href=\"javascript:void('",
                    a, '\')" role="option"><span class="cke_colorbox" style="background-color:#', l, '"></span></a></td>')
            ...
            _: {
                onShow: function() {
                    ...
                    for (var e = 0; e < j.length; e++) {
                        ...
                        if (i) for (var f in i) {
                            ...
                            if (h && (!h.command || this.editor.getCommand(h.command)
                                .state)) h.state = i[f], this.add(h)
                        }
                    }
                },
                onClick: function(a) {
                ...
                showSubMenu: function(a) {
                    ...
                    if (c = c.getItems && c.getItems()) {
                        ...
                        var i = this._.panel.getBlock(this.id)
                            .element.getDocument()
                            .getById(this.id + ("" + a));
                        setTimeout(function() {
                            b.show(i,
                        ...
                        if (CKEDITOR.env.opera && !("oncontextmenu" in document.body)) {
                            ...
                            b.on("mousedown", function(a) {
                                ...
                                if (2 != a.$.button) a.getKeystroke() == CKEDITOR.CTRL + 1 && b.fire("contextmenu", a);
                                    ...
                                    var g = a.getTarget();
                                    c || (g = g.getDocument(), c = g.createElement("input"), c.$.type = "button", g.getBody()
                                        .append(c));
    ...
    (function() {
                ...
                if (!a.blockless) {
                    ...
                    a.addCommand("creatediv", new CKEDITOR.dialogCommand("creatediv", {
                        ...
                        refresh: function(a, b) {
                            this.setState("div" in (a.config.div_wrapTable ? b.root : b.blockLimit)
                                .getDtd() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED)
                        }
                    }));
                    ...
                    a.addCommand("removediv", {
                        exec: function(a) {
                            function b(c) {
                                if ((c = CKEDITOR.plugins.div.getSurroundDiv(a,
                                c)) && !c.data("cke-div-added")) f.push(c), c.data("cke-div-added")
                            }
        ...
        CKEDITOR.plugins.div = {
            getSurroundDiv: function(a, b) {
                ...
                return a.elementPath(h.blockLimit)
                    .contains("div",
                1)
            }
        }
            ...
            exec: function(c) {
                ...
                (e = b.getNextRange()) && ++g;) {
                    ...
                    for (e.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; a = e.getNextParagraph();) if (!a.getCustomData("list_block")) {
                        ...
                        m || (m = k, m.getCustomData("list_group_object_" + g) ? m.getCustomData("list_group_object_" + g)
                            .contents.push(a) : (d = {
                            root: m,
                            contents: [a]
    ...
    (function() {
        ...
        p.prototype = {
            ...
            exec: function(d) {
                function i(n) {
                    for (var h = l.startContainer, b = l.endContainer; h && !h.getParent()
                        .equals(n);) h = h.getParent();
                    for (; b && !b.getParent()
                        .equals(n);) b = b.getParent();
                    if (h && b) {
                ...
                for (var e = this, o = {}, g = d.getSelection(), v = g.createBookmarks(1), l, p = (g && g.getRanges(1))
                    .createIterator(); l = p.getNextRange();) {
    ...
    (function() {
        function m(a, d, b) {
            ...
            a.elementPath()
                .isContextFor("p") || (d = CKEDITOR.ENTER_BR, b = 1);
            a.fire("saveSnapshot");
        ...
        function p(a) {
            for (var a = a.getSelection()
                .getRanges(!0), d = a.length - 1; 0 < d; d--) a[d].deleteContents();
            return a[0]
        }
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function(a, d, b, i) {
                if (b = b || p(a)) {
                    var f = b.document,
                        ...
                        h = b.checkEndOfBlock(),
                        c = a.elementPath(b.startContainer)
                            .block;
                    if (j && h) {
                        if (c && (c.is("li") || c.getParent()
                            .is("li"))) {
                        ...
                        if (c && c.getParent()
                            ...
                            c.getPrevious()
                                .getFirst(CKEDITOR.dom.walker.invisible(1)) || c.getPrevious()
                                .remove();
                            c.getNext()
                                .getFirst(CKEDITOR.dom.walker.invisible(1)) || c.getNext()
                                .remove();
                    ...
                    if (l) {
                        ...
                        if (!j && !h) {
                            if (a.is("li")) {
                                ...
                                (g = e.next()) && (g.type == CKEDITOR.NODE_ELEMENT && g.is("ul", "ol")) && (CKEDITOR.env.ie ? f.createText(" ") : f.createElement("br"))
                                    .insertBefore(g)
                            }
            ...
            enterBr: function(a, d, b, i) {
                if (b = b || p(a)) {
                    var f = b.document,
                        j = b.checkEndOfBlock(),
                        h = new CKEDITOR.dom.elementPath(a.getSelection()
                            .getStartElement()),
                        c = h.block,
                        h = c && h.block.getName();
                    !i && "li" == h ? o(a, d, b, i) : (!i && j && q.test(h) ? (j = c.getDirection()) ? (f = f.createElement("div"), f.setAttribute("dir",
                    j), f.insertAfter(c), b.setStart(f, 0)) : (f.createElement("br")
                        .insertAfter(c), CKEDITOR.env.gecko && f.createText("")
                        .insertAfter(c), b.setStartAt(c.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (c = "pre" == h && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") : f.createElement("br"), b.deleteContents(), b.insertNode(c), CKEDITOR.env.ie ? b.setStartAt(c, CKEDITOR.POSITION_AFTER_END) : (f.createText("﻿")
                        .insertAfter(c), j && c.getParent()
                        .appendBogus(), c.getNext()
                        .$.nodeValue = "", b.setStartAt(c.getNext(), CKEDITOR.POSITION_AFTER_START))), b.collapse(!0), b.select(), b.scrollIntoView())
                }
            }
        };
        ...
        popup: function(e, a, b, d) {
            ...
            try {
                -1 == navigator.userAgent.toLowerCase()
                    .indexOf(" chrome/") && (c.moveTo(g, f), c.resizeTo(a, b)), c.focus(), c.location.href = e
            } catch (h) {
    ...
    (function() {
        ...
        function l() {
            var a = this.getDialog();
            a.getParentEditor()
                ._.filebrowserSe = this;
            return !a.getContentElement(this["for"][0], this["for"][1])
                .getInputElement()
                .$.value || !a.getContentElement(this["for"][0], this["for"][1])
                .getAction() ? !1 : !0
        }
        function m(a, c, d) {
            var b = d.params || {};
        ...
        function j(a, c, d, b) {
            ...
            for (g in b) if (e = b[g], ("hbox" == e.type || "vbox" == e.type || "fieldset" == e.type) && j(a, c, d, e.children), e.filebrowser) if ("string" == typeof e.filebrowser && (e.filebrowser = {
                ...
                e.filebrowser.url = f;
                e.hidden = !1;
                m(a, d.getContents(e["for"][0])
                    .get(e["for"][1]), e.filebrowser)
            }
        }
        function h(a, c, d) {
            if (-1 !== d.indexOf(";")) {
    ...
    CKEDITOR.plugins.add("find", {
        ...
        init: function(a) {
            ...
            b.canUndo = !1;
            b.readOnly = 1;
            a.addCommand("replace", new CKEDITOR.dialogCommand("replace"))
                .canUndo = !1;
        ...
        function p(a) {
            var e, f = a.config,
                ...
                i = function(c) {
                    ...
                    if (e) {
                        ...
                        d.setStyle(h, r(("pin" == e ? u : p) + m + ("pin" == e ? 0 : "left" == h ? s : -s)))
            ...
            if (n) {
                ...
                d.on("mousedown", function(a) {
                    a = a.data;
                    a.getTarget()
                        .hasAscendant("a", 1) || a.preventDefault()
                });
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
                ...
                proto: {
                    ...
                    hideGroup: function(a) {
                        var b = (a = this.element.getDocument()
                            .getById(this._.groups[a])) && a.getNext();
                        a && (a.setStyle("display", "none"), b && "ul" == b.getName() && b.setStyle("display", "none"))
                    },
                    hideItem: function(a) {
                        this.element.getDocument()
                    ...
                    focus: function(a) {
                        this._.focusIndex = -1;
                        if (a) {
                            for (var b = this.element.getDocument()
                                .getById(this._.items[a])
                                .getFirst(), a = this.element.getElementsByTag("a"), c, d = -1; c = a.getItem(++d);) if (c.equals(b)) {
                                this._.focusIndex = d;
                                break
                            }
                            setTimeout(function() {
            ...
            proto: {
                ...
                render: function(a, b) {
                    ...
                    c = {
                        ...
                        title: this.title,
                        cls: this.className || "",
                        titleJs: c.gecko && 10900 <= c.version && !c.hc ? "" : (this.title || "")
                            .replace("'", ""),
                        keydownFn: k,
                        mousedownFn: m,
                        focusFn: l,
    ...
    CKEDITOR.plugins.add("forms", {
        ...
        init: function(b) {
            var a = b.lang,
                ...
                c, d) {
                    ...
                    b.ui.addButton && b.ui.addButton(g, {
                        label: a.common[g.charAt(0)
                            .toLowerCase() + g.slice(1)],
                        command: c,
                        toolbar: "forms," + (e += 10)
                    });
            ...
            b.contextMenu && (!b.blockless && b.contextMenu.addListener(function(g,
            c, a) {
    ...
    (function() {
        function n(a) {
            ...
            this.setup();
            CKEDITOR.env.ie && (d.getDocumentElement()
                .addClass(d.$.compatMode), c.config.enterMode != CKEDITOR.ENTER_P && d.on("selectionchange", function() {
                var a = d.getBody(),
                    b = c.getSelection(),
                    e = b && b.getRanges()[0];
                e && (a.getHtml()
                    .match(/^<p>&nbsp;<\/p>$/i) && e.startContainer.equals(a)) && setTimeout(function() {
                    e = c.getSelection()
                        .getRanges()[0];
            ...
            if (c.config.disableObjectResizing) try {
                this.getDocument()
                    .$.execCommand("enableObjectResizing", !1, !1)
            } catch (g) {
            ...
            c.document.getElementsByTag("title")
                .getItem(0)
                .data("cke-title",
            c.document.$.title);
        ...
        function o(a) {
            if (!a.readOnly) {
                ...
                if (!f || 1 == f && e.type == CKEDITOR.NODE_ELEMENT && e.hasAttribute("_moz_editor_bogus_node")) {
                    ...
                    d.$.dispatchEvent(j);
                    (h != g.$.scrollTop || i != g.$.scrollLeft) && e.getWindow()
                        .$.scrollTo(i, h);
                    f && b.getFirst()
                        .remove();
                    d.getBody()
            ...
            init: function(a) {
                a.addMode("wysiwyg", function(c) {
                    ...
                    CKEDITOR.env.webkit && (f = function() {
                        ...
                        e.removeStyle("width");
                        b.show()
                    }, b.setCustomData("onResize", f), CKEDITOR.document.getWindow()
                        .on("resize", f));
                    a.fire("ariaWidget", b)
                })
            }
                ...
                proto: {
                    setData: function(a, c) {
                        ...
                        if (c) this.setHtml(a);
                            ...
                            var b = d.config,
                                e = b.fullPage,
                                f = b.docType,
                                g = CKEDITOR.tools.buildStyleHtml(q())
                    ...
                    getData: function(a) {
                        ...
                        var a = this.editor,
                            ...
                            e = this.getDocument(),
                            c = c ? e.getDocumentElement()
                                .getOuterHtml() : e.getBody()
                                .getHtml();
    ...
    CKEDITOR.plugins.add("link", {
        ...
        onLoad: function() {
            function b(b) {
                return c.replace(/%1/g, "rtl" == b ? "right" : "left")
    ...
    CKEDITOR.plugins.link = {
        getSelectedLink: function(b) {
            ...
            return c && c.is("a") ? c : (a = a.getRanges(!0)[0]) ? (a.shrink(CKEDITOR.SHRINK_TEXT), b.elementPath(a.getCommonAncestor())
                .contains("a", 1)) : null
        },
    ...
    (function() {
        ...
        function q(a, b, d) {
            return b = b[d ? "getPrevious" : "getNext"](function(e) {
                return e && e.type == CKEDITOR.NODE_TEXT && !y(e) || l(e) && !o(e) && !u(a, e)
            })
        }
        function ca(a) {
            var b = a.doc,
            ...
            p(d, {
                ...
                place: function() {
                    ...
                    d && i ? g.top = d.size.margin.bottom === i.size.margin.top ? 0 | d.size.bottom + d.size.margin.bottom / 2 : d.size.margin.bottom < i.size.margin.top ? d.size.bottom + d.size.margin.bottom : d.size.bottom + d.size.margin.bottom - i.size.margin.top : d ? i || (g.top = d.size.bottom + d.size.margin.bottom) : g.top = i.size.top - i.size.margin.top;
                    ...
                    a.inInlineMode && (g.top--, g.top += e.editable.scroll.top, g.left += e.editable.scroll.left);
                    for (var Q in g) g[Q] = CKEDITOR.tools.cssLength(g[Q]);
                    this.setStyles(g)
                },
                look: function(a) {
                    if (this.oldLook != a) {
                        for (var d = this.lineChildren.length, c; d--;)(c = this.lineChildren[d])
                            .setAttribute("style", c.base + c.looks[0 | a / 2]);
                        this.oldLook = a
                    }
                },
        ...
        function K(a, b, d) {
            var e = new CKEDITOR.dom.range(a.doc),
                f = a.editor,
                c;
            n.ie && a.enterMode == CKEDITOR.ENTER_BR ? c = a.doc.createText(D) : (c = new J(a.enterBehavior, a.doc), a.enterMode != CKEDITOR.ENTER_BR && a.doc.createText(D)
                .appendTo(c));
        ...
        function U(a) {
            ...
            m(a, b);
            return !c && 0 <= b.size.top && 0 < d.y && d.y < b.size.top + f ? (a = a.inInlineMode || 0 === e.scroll.y ? w : r, new t([null, b, C, F, a])) : c && b.size.bottom <= e.pane.height && d.y > b.size.bottom - f && d.y < e.pane.height ? (a = a.inInlineMode || b.size.bottom > e.pane.height - f && b.size.bottom < e.pane.height ? x : r, new t([b, null, V, F, a])) : null
        }
        function W(a) {
            var b = a.mouse,
                d = a.view,
            ...
            if (o(f) || ea(a, f, i) || f.getParent()
                .is(X)) return null;
            var h = q(a, f, !i);
            if (h) {
                if (h && h.type == CKEDITOR.NODE_TEXT) return null;
                if (l(h)) {
                    if (o(h) || !E(a, h) || h.getParent()
                        .is(X)) return null;
                    c = [h, f][i ? "reverse" : "concat"]()
                        .concat([L, F])
                }
            } else f.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? (B(a), i && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom < d.pane.height ? j = x : 0 < b.y && b.y < f.size.top + e && (j = w)) : j = r, c = [null, f][i ? "reverse" : "concat"]()
                .concat([i ? V : C, F, j, f.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? i ? x : w : r]);
        ...
        function m(a, b, d) {
            ...
            if (b.size) {
                if (b.size.ignoreScroll == d && b.size.date > new Date - Y) return null
            } else b.size = {};
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function(a) {
                ...
                a.on("contentDom", function() {
                    ...
                    b.is(v.$inline) || (c.inInlineMode && !T(b) && b.setStyles({
                    ...
                    }, null, null, 0), b.attachListener(c.inInlineMode ? e : e.getWindow()
                        .getFrame(), "mouseout", function(b) {
                        ...
                        if ("wysiwyg" == a.mode) switch (b = b.data.getKeystroke(), a.getSelection()
                            .getStartElement(), b) {
                        case 2228240:
                        case 16:
                        ...
                        i = !0;
                        if (!("wysiwyg" != a.mode || a.readOnly || h)) {
                            var d = {
                                x: b.data.$.clientX,
                                y: b.data.$.clientY
                            };
                            h = setTimeout(function() {
                                ...
                                h = c.trigger = null;
                                G(c);
                                if (i && !c.hiddenMode && a.focusManager.hasFocus && !c.line.mouseNear() && (c.element = Z(c, !0)))(c.trigger = U(c) || W(c) || $(c)) ? c.line.attach()
                                    .place() : (c.trigger = null, c.line.detach()), i = !1
                            }, 30)
                        }
                        ...
                        for (var a = e.getElementsByTag(c.enterBehavior), b, d = a.count(); d--;) if ((b = a.getItem(d))
                            .hasAttribute("data-cke-magicline-hot")) {
                            c.hotNode = b;
                            c.lastCmdDirection = "true" === b.getAttribute("data-cke-magicline-dir") ? !0 : !1;
                            break
                        }
                    }), this.backdoor = {
                        accessFocusSpace: K,
        ...
        var Z = function() {
            ...
            $ = function() {
                function a(a) {
                    ...
                    if (f && e.contains(f)) for (; !f.getParent()
                        .equals(e);) f = f.getParent();
                    else f = e.getFirst(function(c) {
                        return b(a, c)
                    });
                    if (c && e.contains(c)) for (; !c.getParent()
                        .equals(e);) c = c.getParent();
                ...
                function b(a, b) {
                    return !(b && b.type == CKEDITOR.NODE_TEXT || z(b) || o(b) || u(a, b) || b.type == CKEDITOR.NODE_ELEMENT && b.$ && b.is("br"))
                }
                return function(b) {
                    var e = a(b),
                        f;
                        ...
                        exec: function() {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                b.getDocumentElement()
                                    .setStyles(g);
                                !CKEDITOR.env.gecko && b.getDocumentElement()
                                    .setStyle("position", "fixed");
                                (!CKEDITOR.env.gecko || !CKEDITOR.env.quirks) && b.getBody()
                                    .setStyles(g);
                                CKEDITOR.env.ie ? setTimeout(function() {
                                    d.$.scrollTo(0, 0)
                                }, 0) : d.$.scrollTo(0, 0);
                            ...
                            this.toggleState();
                            if (c = this.uiItems[0]) g = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize, c = CKEDITOR.document.getById(c._.id), c.getChild(1)
                                .setHtml(g), c.setAttribute("title", g), c.setAttribute("href", 'javascript:void("' + g + '");');
                            "wysiwyg" == a.mode ? j ? (CKEDITOR.env.gecko && q(a), a.getSelection()
                                .selectRanges(j), (i = a.getSelection()
                                .getStartElement()) && i.scrollIntoView(!0)) : d.$.scrollTo(k.x, k.y) : (j && (i.selectionStart = j[0], i.selectionEnd = j[1]), i.scrollLeft = k[0], i.scrollTop = k[1]);
                            j = k = null;
                            l = this.state;
    ...
    CKEDITOR.plugins.add("pagebreak", {
        ...
        onLoad: function() {
            var a = ["{", "background: url(" + CKEDITOR.getUrl(this.path + "images/pagebreak.gif") + ") no-repeat center center;", "clear: both;width:100%; _width:99.9%;border-top: #999999 1px dotted;border-bottom: #999999 1px dotted;padding:0;height: 5px;cursor: default;}"].join("")
                .replace(/;/g, " !important;");
        ...
        init: function(a) {
            a.blockless || (a.addCommand("pagebreak", CKEDITOR.plugins.pagebreakCmd), a.ui.addButton && a.ui.addButton("PageBreak", {
                ...
                a.document.on("click", function(b) {
                    b = b.data.getTarget();
                    b.is("div") && b.hasClass("cke_pagebreak") && a.getSelection()
                        .selectElement(b)
                })
            }))
        },
    ...
    (function() {
        var g, i = {
            ...
            exec: function(a) {
                ...
                if (b.fullPage) a = a.getData()
                    .replace(/<head>/, "$&" + e)
                    .replace(/[^>]*(?=<\/title>)/, "$& &mdash; " + a.lang.preview.preview);
                else {
                    var b = "<body ",
    ...
    CKEDITOR.plugins.removeformat = {
        commands: {
            removeformat: {
                exec: function(a) {
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, k = a.getSelection()
                        .getRanges(1), l = k.createIterator(), c; c = l.getNextRange();) {
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("save", {
            init: function(a) {
                a.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE && (a.addCommand("save", b)
                    .modes = {
        ...
        CKEDITOR.plugins.add("selectall", {
            init: function(b) {
                b.addCommand("selectAll", {
                    ...
                    exec: function(a) {
                        var b = a.editable();
                        if (b.is("textarea")) a = b.$, CKEDITOR.env.ie ? a.createTextRange()
                            .execCommand("SelectAll") : (a.selectionStart = 0, a.selectionEnd = a.value.length), a.focus();
                        else {
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("showblocks", {
            onLoad: function() {
                function a(a) {
                    return ".%1.%2 p,.%1.%2 div,.%1.%2 pre,.%1.%2 address,.%1.%2 blockquote,.%1.%2 h1,.%1.%2 h2,.%1.%2 h3,.%1.%2 h4,.%1.%2 h5,.%1.%2 h6{background-position: top %3;padding-%3: 8px;}".replace(/%1/g, "cke_show_blocks")
                        .replace(/%2/g, "cke_contents_" + a)
                        .replace(/%3/g, "rtl" == a ? "right" : "left")
                }
                CKEDITOR.addCss(".%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;border: 1px dotted gray;padding-top: 8px;}.%2 p{%1p.png);}.%2 div{%1div.png);}.%2 pre{%1pre.png);}.%2 address{%1address.png);}.%2 blockquote{%1blockquote.png);}.%2 h1{%1h1.png);}.%2 h2{%1h2.png);}.%2 h3{%1h3.png);}.%2 h4{%1h4.png);}.%2 h5{%1h5.png);}.%2 h6{%1h6.png);}".replace(/%1/g, "background-image: url(" + CKEDITOR.getUrl(this.path) + "images/block_")
                    .replace(/%2/g, "cke_show_blocks ") + a("ltr") + a("rtl"))
            },
            init: function(a) {
                if (!a.blockless) {
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("showborders", {
            ...
            onLoad: function() {
                var a;
                a = (CKEDITOR.env.ie6Compat ? [".%1 table.%2,", ".%1 table.%2 td, .%1 table.%2 th", "{", "border : #d3d3d3 1px dotted", "}"] : ".%1 table.%2,;.%1 table.%2 > tr > td, .%1 table.%2 > tr > th,;.%1 table.%2 > tbody > tr > td, .%1 table.%2 > tbody > tr > th,;.%1 table.%2 > thead > tr > td, .%1 table.%2 > thead > tr > th,;.%1 table.%2 > tfoot > tr > td, .%1 table.%2 > tfoot > tr > th;{;border : #d3d3d3 1px dotted;}".split(";"))
                    .join("")
            ...
            init: function(a) {
                ...
                a.on("removeFormatCleanup", function(d) {
                    d = d.data;
                    a.getCommand("showborders")
                        .state == CKEDITOR.TRISTATE_ON && (d.is("table") && (!d.hasAttribute("border") || 0 >= parseInt(d.getAttribute("border"), 10))) && d.addClass("cke_show_border")
                })
            },
            afterInit: function(a) {
                var b = a.dataProcessor,
                ...
                b && b.addRules({
                    elements: {
                        table: function(a) {
                            var a = a.attributes,
                                b = a["class"];
                            b && (a["class"] = b.replace("cke_show_border", "")
                                .replace(/\s{2}/, " ")
                                .replace(/^\s+|\s+$/, ""))
                        }
                    }
        ...
        CKEDITOR.on("dialogDefinition", function(a) {
            var b = a.data.name;
            if ("table" == b || "tableProperties" == b) if (a = a.data.definition, b = a.getContents("info")
                .get("txtBorder"), b.commit = CKEDITOR.tools.override(b.commit, function(a) {
                return function(b, c) {
                    a.apply(this, arguments);
    ...
    (function() {
        CKEDITOR.plugins.add("sourcearea", {
            init: function(a) {
                function d() {
                    this.hide();
                    this.setStyle("height", this.getParent()
                        .$.clientHeight + "px");
                    this.setStyle("width", this.getParent()
                        .$.clientWidth + "px");
                    this.show()
                }
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
        ...
        var i = "",
            r = function() {
                ...
                var b = this,
                    f = function() {
                        if (!("undefined" != typeof d.instances[b.name] || null != d.instances[b.name])) {
                            var a = b.config,
                                c = {};
                            c.srcNodeRef = "BODY" == b.editable()
                                .$.nodeName ? b.document.getWindow()
                                .$.frameElement : b.editable()
                                .$;
                            ...
                            c.onLoad = function() {
                                ...
                                b.editable()
                                    .hasFocus && !d.isControlRestored(b) && this.focus()
                            };
                            ...
                            o.afterMarkupRemove.push(function(a) {
                                (new CKEDITOR.dom.element(a, o.document))
                                    .mergeSiblings()
                            });
                ...
                b.on("insertElement", function() {
                    var a = d.getScayt(b);
                    d.isScaytEnabled(b) && (CKEDITOR.env.ie && b.getSelection()
                        .unlock(!0), window.setTimeout(function() {
                        a.focus();
                        a.refresh()
                    }, 10))
                }, this, null, 50);
        ...
        CKEDITOR.plugins.scayt = {
            ...
            loadEngine: function(a) {
                ...
                void 0 == window.scayt ? (CKEDITOR._djScaytConfig = {
                    ...
                    isDebug: !1
                }, CKEDITOR.document.getHead()
                    .append(CKEDITOR.document.createElement("script", {
                    attributes: {
                        type: "text/javascript",
                        async: "true",
                        src: c
            ...
            init: function(a) {
                ...
                a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
                    ...
                    onMenu: function() {
                        ...
                        a.getMenuItem("scaytToggle")
                            .label = g[b ? "disable" : "enable"];
                        var c = d.getUiTabs(a);
                        return {
    ...
    (function() {
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function(d) {
                function k(a) {
                    d.getStylesSet(function(g) {
                        if (!j.length) {
                            for (var b, f, e = 0, c = g.length; e < c; e++) b = g[e], d.blockless && b.element in CKEDITOR.dtd.$block || (f = b.name, b = h[f] = new CKEDITOR.style(b), b._name = f, b._.enterMode = l.enterMode, b._.weight = e + 1E3 * (b.type == CKEDITOR.STYLE_OBJECT ? 1 : b.type == CKEDITOR.STYLE_BLOCK ? 2 : 3), j.push(b));
                            j.sort(function(a, b) {
                ...
                d.ui.addRichCombo("Styles", {
                    ...
                    init: function() {
                        ...
                        k(function() {
                            var a, g, b, f, e, d;
                            e = 0;
                            for (d = j.length; e < d; e++) a = j[e], g = a._name, f = a.type, f != b && (c.startGroup(i["panelTitle" + f]), b = f), c.add(g, a.type == CKEDITOR.STYLE_OBJECT ? g : a.buildPreview(), g);
                            c.commit()
                        })
                    },
                    onClick: function(a) {
                        ...
                        var a = h[a],
                            g = d.elementPath();
                        d[a.checkActive(g) ? "removeStyle" : "applyStyle"](a);
                        d.fire("saveSnapshot")
                    },
                    onRender: function() {
                        d.on("selectionChange", function(a) {
                            for (var d = this.getValue(), a = a.data.path.elements, b = 0, f = a.length, e; b < f; b++) {
                                e = a[b];
                                for (var c in h) if (h[c].checkElementRemovable(e, !0)) {
                                    c != d && this.setValue(c);
                                    return
                                }
                            }
                    ...
                    onOpen: function() {
                        ...
                        for (var b in h) {
                            var f = h[b],
                                e = f.type;
                            e == CKEDITOR.STYLE_BLOCK && !a.isContextFor(f.element) ? this.hideItem(b) : (f.checkActive(a) ? this.mark(b) : e == CKEDITOR.STYLE_OBJECT && !f.checkApplicable(a) && (this.hideItem(b), c[e]--), c[e]++)
                        }
                        c[CKEDITOR.STYLE_BLOCK] || this.hideGroup(i["panelTitle" + CKEDITOR.STYLE_BLOCK]);
                        c[CKEDITOR.STYLE_INLINE] || this.hideGroup(i["panelTitle" + CKEDITOR.STYLE_INLINE]);
                        c[CKEDITOR.STYLE_OBJECT] || this.hideGroup(i["panelTitle" + CKEDITOR.STYLE_OBJECT])
                    },
                    reset: function() {
                        c && (delete c._.panel, delete c._.list, c._.committed = 0, c._.items = {}, c._.state = CKEDITOR.TRISTATE_OFF);
                        h = {};
                        j = [];
                        k()
                    }
                ...
                exec: function(d) {
                    if (d.editable()
                        ...
                        var e = d.getSelection(),
                            b;
                        if (b = (new CKEDITOR.dom.elementPath(e.getCommonAncestor(), e.root))
                            .contains({
                            td: 1,
                            th: 1
                        }, 1)) {
                            var e = d.createRange(),
                                a = CKEDITOR.tools.tryThese(function() {
                                    var a = b.getParent()
                                        .$.cells[b.$.cellIndex + (c ? -1 : 1)];
                                    a.parentNode.parentNode;
                                    return a
                                }, function() {
                                    var a = b.getParent(),
                                        a = a.getAscendant("table")
                                            .$.rows[a.$.rowIndex + (c ? -1 : 1)];
                                    return a.cells[c ? a.cells.length - 1 : 0]
                                });
                            if (!a && !c) {
                                for (var f = b.getAscendant("table")
                                    .$, a = b.getParent()
                                    .$.cells, f = new CKEDITOR.dom.element(f.insertRow(-1), d.document), g = 0, h = a.length; g < h; g++) {
                                    var i = f.append((new CKEDITOR.dom.element(a[g], d.document))
                                        .clone(!1, !1));
    ...
    CKEDITOR.dom.element.prototype.focusNext = function(i, h) {
        ...
        } else for (b = this.getDocument()
            .getBody()
            .getFirst(); b = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
    ...
    CKEDITOR.dom.element.prototype.focusPrevious = function(i, h) {
        for (var g = void 0 === h ? this.getTabIndex() : h, f, c, d, e = 0, b, a = this.getDocument()
            .getBody()
            .getLast(); a = a.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
    ...
    (function() {
            ...
            for (var c = c.getRanges(), b = [], a = {}, e = 0; e < c.length; e++) {
                ...
                if (f.collapsed) f = f.getCommonAncestor(), (f = f.getAscendant("td", !0) || f.getAscendant("th", !0)) && b.push(f);
                    ...
                    var f = new CKEDITOR.dom.walker(f),
                        g;
                    for (f.guard = d; g = f.next();) if (g.type != CKEDITOR.NODE_ELEMENT || !g.is(CKEDITOR.dtd.table)) if ((g = g.getAscendant("td", !0) || g.getAscendant("th", !0)) && !g.getCustomData("selected_cell")) CKEDITOR.dom.element.setMarker(a, g, "selected_cell", !0), b.push(g)
                }
            }
        ...
        function m(c, d) {
            for (var b = o(c), a = b[0], e = a.getAscendant("table"), a = a.getDocument(), f = b[0].getParent(), g = f.$.rowIndex, b = b[b.length - 1], h = b.getParent()
                .$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(e.$.rows[h]), g = d ? g : h, f = d ? f : b, b = CKEDITOR.tools.buildTableMap(e), e = b[g], g = d ? b[g - 1] : b[g + 1], b = b[0].length,
            a = a.createElement("tr"), h = 0; e[h] && h < b; h++) {
                var i;
                1 < e[h].rowSpan && g && e[h] == g[h] ? (i = e[h], i.rowSpan += 1) : (i = (new CKEDITOR.dom.element(e[h]))
                    .clone(), i.removeAttribute("rowSpan"), !CKEDITOR.env.ie && i.appendBogus(), a.append(i), i = i.$);
                h += i.colSpan - 1
            }
        ...
        function p(c) {
            if (c instanceof CKEDITOR.dom.selection) {
                for (var d = o(c), b = d[0].getAscendant("table"), a = CKEDITOR.tools.buildTableMap(b), c = d[0].getParent()
                    .$.rowIndex, d = d[d.length - 1], e = d.getParent()
                    .$.rowIndex + d.$.rowSpan - 1, d = [],
                f = c; f <= e; f++) {
                    for (var g = a[f], h = new CKEDITOR.dom.element(b.$.rows[f]), i = 0; i < g.length; i++) {
                        var j = new CKEDITOR.dom.element(g[i]),
                            k = j.getParent()
                                .$.rowIndex;
                        1 == j.$.rowSpan ? j.remove() : (j.$.rowSpan -= 1, k == f && (k = a[f + 1], k[i - 1] ? j.insertAfter(new CKEDITOR.dom.element(k[i - 1])) : (new CKEDITOR.dom.element(b.$.rows[f + 1]))
                            .append(j, 1)));
                        i += j.$.colSpan - 1
                    }
                    d.push(h)
        ...
        function q(c, d) {
            for (var b = d ? Infinity : 0, a = 0; a < c.length; a++) {
                var e;
                e = c[a];
                for (var f = d, g = e.getParent()
                    .$.cells, h = 0, i = 0; i < g.length; i++) {
                    var j = g[i],
                        h = h + (f ? 1 : j.colSpan);
                    if (j == e.$) break
                }
        ...
        function n(c, d) {
            ...
            for (h = 0; h < g; h++) a[h] && (1 < a[h].colSpan && b[h] == a[h] ? (e = a[h], e.colSpan += 1) : (e = (new CKEDITOR.dom.element(a[h]))
                .clone(), e.removeAttribute("colSpan"), !CKEDITOR.env.ie && e.appendBogus(), e[d ? "insertBefore" : "insertAfter"].call(e, new CKEDITOR.dom.element(a[h])), e = e.$), h += e.rowSpan - 1)
        }
        function t(c, d) {
    ...
    (function() {
        ...
        h.prototype = {
            ...
            restoreImage: function(a) {
                ...
                a.bookmarks ? b.selectBookmarks(a.bookmarks) : CKEDITOR.env.ie && (c = this.editor.document.getBody()
                    .$.createTextRange(), c.collapse(!0), c.select());
                this.locked = 0;
                this.index = a.index;
                this.update();
                this.fireChange()
    ...
    CKEDITOR.plugins.add("wsc", {
        requires: "dialog",
        init: function(a) {
            a.addCommand("checkspell", new CKEDITOR.dialogCommand("checkspell"))
                .modes = {
            ...
            (function() {
                var e = function(d, a, j) {
                    if (!(3 > arguments.length)) {
                        ...
                        d.on("load", function() {
                            CKEDITOR.document.getById(f.frameId)
                                .getParent()
                                .setStyles({
                                width: g,
                                height: h
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, d, a, k, "iframe", {
                            width: g,
                            height: h
                        }, i, "");
                        ...
                        k = k.join("");
                        d.on("show", function() {
                            var b = CKEDITOR.document.getById(f.frameId)
                                .getParent(),
    ...
    CKEDITOR.plugins.add("uploadcare", {
        ...
        init: function(b) {
            ...
            CKEDITOR.scriptLoader.load(c.path + "config.js");
            b.addCommand("uploadcareDialog", new CKEDITOR.dialogCommand("uploadcareDialog"));
            b.addCommand("showUploadcareDialog", {
                exec: function() {
                    // jQuery(".cke_button__uploadcare_icon").html("");
                    var c = new uploadcare.uploader.Uploader,
                        e = new uploadcare.ui.progress.Circle(".cke_button__uploadcare_icon");
                    uploadcare.widget.showDialog()
                        .pipe(function(a) {
                        a = c.upload(a);
                        e.listen(a);
                        return a
                        ...
                        .done(function(a) {
                        d = a.fileId;
                        b.execCommand("uploadcareDialog", !0)
                    })
                }
            });
            b.ui.addButton("Uploadcare", {
                label: "Uploadcare",
            ...
            CKEDITOR.dialog.add("uploadcareDialog", function() {
                return {
                    ...
                    minHeight: 600,
                    onShow: function() {
                        document.getElementById(this.getButton("ok")
                            .domId)
                            .style.display = "none"
                    },
                    contents: [{
                        ...
                        elements: [{
                            type: "iframe",
                            src: c.path + "dialog.php?file_id=" + d,
                            width: "800",
                            height: "600",
                            onContentLoad: function() {
                                document.getElementById(this._.frameId)
                                    .contentWindow.document.getElementById("editor_name")
                                    .value = b.name
                            }
                        }]
                    }]
    ...
    CKEDITOR.plugins.add("wordcount", {
        ...
        init: function(a) {
            ...
            function e(c) {
                var a = 0,
                    b = 0;
                if (c.getData() && (d.showWordCount && (a = j(c.getData())
                    .trim()
                    .split(/\s+/)
                    .length), d.showCharCount)) b = j(c.getData())
                    .trim()
                    .length;
                var e = k.replace("%wordCount%", a)
                    .replace("%charCount%", b);
                document.getElementById("cke_wordcount_" + c.name)
                    .innerHTML = e;
                if (b == l) return !0;
                l = b;
                a > f ? m(c, g) : !h && a < f && (h = !0, g = !1, c.config.Locked = 0);
                return !0
            }
            function m(a, b) {
                g = !0;
                h = !1;
                a.execCommand("undo");
                b || a.fire("limitReached", {}, a);
                a.config.Locked = 1;
                a.fire("change")
            }
            var b = '<span class="cke_path_item">',
                f = "unlimited",
                i, l = 0,
                g = !1,
                h = !1,
            ...
            d.showCharCount && (b += a.lang.wordcount.CharCount + "&nbsp;%charCount%");
            d.showCharCount && d.showWordCount && (b += ",&nbsp;");
            d.showWordCount && (b += a.lang.wordcount.WordCount + " %wordCount%");
            var k = b + "</span>";
            CKEDITOR.document.appendStyleSheet(this.path + "css/wordcount.css");
            a.on("uiSpace", function(a) {
                "bottom" == a.data.space && (a.data.html += '<div id="cke_wordcount_' + a.editor.name + '" class="cke_wordcount" style="" title="' + CKEDITOR.tools.htmlEncode("Words Counter") + '">&nbsp;</div>')
            }, a, null, 100);
            a.on("instanceReady", function() {
                void 0 != a.config.wordcount_limit && (f = a.config.wordcount_limit);
                void 0 != a.config.wordcount_format && (k = a.config.wordcount_format)
            }, a, null, 100);
            a.on("dataReady", function(c) {
                c.editor.getData()
                    .length > f && m(a);
                e(c.editor)
            }, a, null, 100);
    ...
    (function() {
        ...
        function n(b, i) {
            var a = b.getComputedStyle("border-" + i + "-width"),
                g = {
                    thin: "0px",
                    medium: "1px",
                    thick: "2px"
                };
            0 > a.indexOf("px") && (a = a in g && "none" != b.getComputedStyle("border-style") ? g[a] : 0);
            return parseInt(a, 10)
        }
        function v(b) {
            var i = [],
                a = -1,
                g = "rtl" == b.getComputedStyle("direction"),
                c;
            c = b.$.rows;
            for (var p = 0, e, f, d, h = 0, o = c.length; h < o; h++) d = c[h], e = d.cells.length, e > p && (p = e, f = d);
            c = f;
            p = new CKEDITOR.dom.element(b.$.tBodies[0]);
            e = p.getDocumentPosition();
            f = 0;
            for (d = c.cells.length; f < d; f++) {
                var h = new CKEDITOR.dom.element(c.cells[f]),
                    o = c.cells[f + 1] && new CKEDITOR.dom.element(c.cells[f + 1]),
                    a = a + (h.$.colSpan || 1),
                    k, j, l = h.getDocumentPosition()
                        .x;
                g ? j = l + n(h, "left") : k = l + h.$.offsetWidth - n(h, "right");
                o ? (l = o.getDocumentPosition()
                    .x, g ? k = l + o.$.offsetWidth - n(o, "right") : j = l + n(o, "left")) : (l = b.getDocumentPosition()
                    .x, g ? k = l : j = l + b.$.offsetWidth);
                h = Math.max(j - k, 3);
                i.push({
                    table: b,
                    index: a,
        ...
        function z(b) {
            function i() {
                ...
                f.removeListener("dragstart", u)
            }
            function a() {
                for (var a = e.rtl, b = a ? l.length : w.length, d = 0; d < b; d++) {
                    var c = w[d],
                        f = l[d],
                        g = e.table;
                    CKEDITOR.tools.setTimeout(function(b, d, c, e, f, h) {
                        b && b.setStyle("width", j(Math.max(d + h, 0)));
                        c && c.setStyle("width", j(Math.max(e - h, 0)));
                        f && g.setStyle("width", j(f + h * (a ? -1 : 1)))
                    }, 0, this, [c, c && t(c), f, f && t(f), (!c || !f) && t(g) + n(g, "left") + n(g, "right"), k])
                }
            }
            function g(a) {
                u(a);
                for (var a = e.index, b = CKEDITOR.tools.buildTableMap(e.table), g = [], i = [], j = Number.MAX_VALUE, n = j, s = e.rtl, r = 0, v = b.length; r < v; r++) {
                    var m = b[r],
                        q = m[a + (s ? 1 : 0)],
                        m = m[a + (s ? 0 : 1)],
                        q = q && new CKEDITOR.dom.element(q),
                        m = m && new CKEDITOR.dom.element(m);
                    if (!q || !m || !q.equals(m)) q && (j = Math.min(j, t(q))), m && (n = Math.min(n, t(m))), g.push(q), i.push(m)
                }
                w = g;
                l = i;
                x = e.x - j;
            ...
            function p(a) {
                r(a.data.getPageOffset()
                    .x)
            }
            var e, f, d, h, o, k, w, l, x, y;
            f = b.document;
            d = CKEDITOR.dom.element.createFromHtml('<div data-cke-temp=1 contenteditable=false unselectable=on style="position:absolute;cursor:col-resize;filter:alpha(opacity=0);opacity:0;padding:0;background-color:#004;background-image:none;border:0px none;z-index:10"></div>', f);
            s || f.getDocumentElement()
                .append(d);
            this.attachTo = function(a) {
                ...
                k = 0), e = a, d.setStyles({
                    ...
                    left: j(a.x),
                    top: j(a.y)
                }), s && d.setOpacity(0.25), d.on("mousedown", g, this), f.getBody()
                    .setStyle("cursor", "col-resize"), d.show())
            };
            var r = this.move = function(a) {
                if (!e) return 0;
                if (!h && (a < e.x || a > e.x + e.width)) return e = null, h = k = 0, f.removeListener("mouseup", c), d.removeListener("mousedown", g), d.removeListener("mousemove", p), f.getBody()
                    .setStyle("cursor", "auto"), s ? d.remove() : d.hide(), 0;
        ...
        function r(b) {
            var i = b.data.getTarget();
            if ("mouseout" == b.name) {
                if (!i.is("table")) return;
                for (var a = new CKEDITOR.dom.element(b.data.$.relatedTarget || b.data.$.toElement); a && a.$ && !a.equals(i) && !a.is("body");) a = a.getParent();
                if (!a || a.equals(i)) return
            }
            i.getAscendant("table", 1)
                .removeCustomData("_cke_table_pillars");
            b.removeListener()
        }
        var j = CKEDITOR.tools.cssLength,
            s = CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks);
                ...
                b.on("contentDom", function() {
                    ...
                    b.document.getBody()
                        ...
                        if (i && i.move(g)) u(a);
                            ...
                            var a = a.getTarget(),
                                c;
                            if (a.is("table") || a.getAscendant("tbody", 1)) {
                                c = a.getAscendant("table", 1);
                                if (!(a = c.getCustomData("_cke_table_pillars"))) c.setCustomData("_cke_table_pillars", a = v(c)), c.on("mouseout", r), c.on("mousedown", r);
                                a: {
                                    c = 0;
                                    for (var j = a.length; c < j; c++) {
                                        var e = a[c];
                                        if (g >= e.x && g <= e.x + e.width) {
                                            g = e;
                                            break a
                                        }
                                    }
    ...
    (function() {
        function i(b, h, d) {
            ...
            for (a = 0; a < b.styleSheets.length; a++) {
                ...
                if (!(c.ownerNode || c.owningElement)
                    .getAttribute("data-cke-temp") && !(c.href && "chrome://" == c.href.substr(0, 9))) try {
                    for (var f = c.cssRules || c.rules, c = 0; c < f.length; c++) g.push(f[c].selectorText)
                } catch (i) {}
            }
            a = g.join(" ");
            a = a.replace(/(,|>|\+|~)/g, " ");
            ...
            a = a.split(" ");
            b = [];
            for (g = 0; g < a.length; g++) f = a[g], d.test(f) && !h.test(f) && -1 == CKEDITOR.tools.indexOf(b, f) && b.push(f);
            for (a = 0; a < b.length; a++) d = b[a].split("."), h = d[0].toLowerCase(), d = d[1], e.push({
                name: h + "." + d,
                element: h,
                attributes: {
                    "class": d
                ...
                b.getStylesSet = CKEDITOR.tools.override(b.getStylesSet, function(b) {
                    return function(d) {
                        ...
                        b.call(this, function(b) {
                            d(e._.stylesDefinitions = b.concat(i(e.document.$, e.config.stylesheetParser_skipSelectors || /(^body\.|^\.)/i, e.config.stylesheetParser_validSelectors || /\w+\.\w+/)))
                        })
                    }
                })
            }
            ...
            init: function(a) {
                CKEDITOR.dialog.add("MediaEmbedDialog", function(a) {
                    return {
                        ...
                        onOk: function() {
                            for (var b = 0; b < window.frames.length; b++) "iframeMediaEmbed" == window.frames[b].name && window.frames[b].document.getElementById("embed");
                            div = a.document.createElement("div");
                            div.setHtml(this.getContentElement("iframe", "embedArea")
                                .getValue());
                            a.insertElement(div)
                        }
                    }
                });
                a.addCommand("MediaEmbed", new CKEDITOR.dialogCommand("MediaEmbedDialog"));
    ...
    (function() {
        CKEDITOR.plugins.add("oembed", {
            ...
            lang: ["de", "en", "nl", "fr", "ru"],
            init: function(b) {
                "undefined" == typeof jQuery ? CKEDITOR.scriptLoader.load("http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js", function() {
                    "undefined" == typeof jQuery.fn.oembed && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("oembed") + "libs/jquery.oembed.min.js"))
                }) : "undefined" == typeof jQuery.fn.oembed && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("oembed") + "libs/jquery.oembed.min.js"));
                b.addCommand("oembed", new CKEDITOR.dialogCommand("oembed"));
                b.ui.addButton("oembed", {
                    label: b.lang.oembed.button,
                    command: "oembed",
                    icon: this.path + "images/icon.png"
                });
                CKEDITOR.dialog.add("oembed", function(a) {
                    return {
                        title: a.lang.oembed.title,
                        minWidth: CKEDITOR.env.ie && CKEDITOR.env.quirks ? 568 : 550,
                        minHeight: 155,
                        onOk: function() {
                            var b = this.getValueOf("general", "embedCode");
                            if (1 > b.length || 0 > b.indexOf("http")) return alert(a.lang.oembed.invalidUrl), !1;
                            var d = this.getContentElement("general", "width")
                                .getInputElement()
                                .getValue(),
                                e = this.getContentElement("general", "height")
                                    .getInputElement()
                                    .getValue(),
                            ...
                            jQuery("body")
                                .oembed(b, {
                                onEmbed: function(b) {
                                    "string" === typeof b.code ? (c.insertHtml(null != a.config.oembed_WrapperClass ? '<div class="' + a.config.oembed_WrapperClass + '" />' : "<div />"), c.insertHtml(b.code), CKEDITOR.dialog.getCurrent()
                                        .hide()) : alert(a.lang.oembed.noEmbedCode)
                                },
                                maxHeight: e,
                                maxWidth: d,
                                embedMethod: "editor"
                        ...
                        contents: [{
                            ...
                            elements: [{
                                type: "html",
                                id: "oembedHeader",
                                html: '<div style="white-space:normal;width:500px;padding-bottom:10px">' + a.lang.oembed.pasteUrl + "</div>"
                            }, {
                                type: "text",
                                id: "embedCode",
                                focus: function() {
                                ...
                                label: a.lang.oembed.url,
                                title: a.lang.oembed.pasteUrl
                            }, {
                                type: "hbox",
                                widths: ["50%", "50%"],
                                children: [{
                                    type: "text",
                                    id: "width",
                                    "default": null != a.config.oembed_maxWidth ? a.config.oembed_maxWidth : "560",
                                    label: a.lang.oembed.width,
                                    title: a.lang.oembed.widthTitle
                                }, {
                                    type: "text",
                                    id: "height",
                                    "default": null != a.config.oembed_maxHeight ? a.config.oembed_maxHeight : "315",
                                    label: a.lang.oembed.height,
                                    title: a.lang.oembed.heightTitle
                                }]
                            }]
                        }]
                    }
    ...
    (function() {
        CKEDITOR.plugins.add("maxheight", {
            init: function(a) {
                var b = a.plugins.maxheight,
                    c = window; - 1 != navigator.appVersion.indexOf("MSIE 7.") && (c = a.element.$.parentElement);
                var d = function() {
    ...
    CKEDITOR.plugins.add("symbol", {
        ...
        init: function(a) {
            ...
            a.addCommand("symbol", {
                exec: function() {
                    if (a.config.removeSymbolRanges && 0 < a.config.removeSymbolRanges.length) for (var d = a.config.removeSymbolRanges.length - 1; 0 <= d; d--) {
    ...
    (function() {
        ...
        CKEDITOR.xml = function(c) {
            ...
            if ("object" == typeof c) a = c;
                ...
                .replace(/&nbsp;/g, " "), window.DOMParser) a = (new DOMParser)
        ...
        CKEDITOR.xml.prototype = {
            selectSingleNode: function(c, a) {
                var b = this.baseXml;
                if (a || (a = b)) {
                    if (CKEDITOR.env.ie || a.selectSingleNode) return a.selectSingleNode(c);
            ...
            selectNodes: function(c, a) {
                var b = this.baseXml,
                    d = [];
                if (a || (a = b)) {
                    if (CKEDITOR.env.ie || a.selectNodes) return a.selectNodes(c);
            ...
            getInnerXml: function(c, a) {
                var b = this.selectSingleNode(c, a),
                    d = [];
                if (b) for (b = b.firstChild; b;) b.xml ? d.push(b.xml) : window.XMLSerializer && d.push((new XMLSerializer)
    ...
    (function() {
        ...
        CKEDITOR.ajax = function() {
            var h = function() {
                ...
                if (!c) return null;
                c.open("GET", a, e);
                e && (c.onreadystatechange = function() {
                    4 == c.readyState && (b(d(c)), c = null)
                });
                c.send(null);
                return e ? "" : d(c)
            };
    ...
    CKEDITOR.plugins.add("sourcedialog", {
        init: function(a) {
            ...
            a.ui.addButton && a.ui.addButton("Sourcedialog", {
